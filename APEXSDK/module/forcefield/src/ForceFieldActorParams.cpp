...
const char* const ForceFieldActorParamsFactory::vptr =
    NxParameterized::getVptr<ForceFieldActorParams, ForceFieldActorParams::ClassAlignment>();
...
NxParameterized::MutexType ForceFieldActorParams::mBuiltFlagMutex;

ForceFieldActorParams::ForceFieldActorParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ForceFieldActorParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ForceFieldActorParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ForceFieldActorParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ForceFieldActorParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldActorParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
