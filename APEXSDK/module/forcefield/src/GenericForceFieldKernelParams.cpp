...
const char* const GenericForceFieldKernelParamsFactory::vptr =
    NxParameterized::getVptr<GenericForceFieldKernelParams, GenericForceFieldKernelParams::ClassAlignment>();
...
NxParameterized::MutexType GenericForceFieldKernelParams::mBuiltFlagMutex;

GenericForceFieldKernelParams::GenericForceFieldKernelParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* GenericForceFieldKernelParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* GenericForceFieldKernelParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType GenericForceFieldKernelParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType GenericForceFieldKernelParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GenericForceFieldKernelParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
