...
void ForceFieldAssetPreview::drawForceFieldPreviewIcon(void)
{
	...
	{
		mDrawGroupIconScaled = (physx::PxU32)mApexRenderDebug->beginDrawGroup(physx::PxMat44().createIdentity());
		drawIcon();
...
void	ForceFieldAssetPreview::setDrawGroupsPoseScaled()
{
			...
			mApexRenderDebug->setDrawGroupPose((physx::PxI32)mDrawGroupIconScaled, scaledPose);
}
...
void	ForceFieldAssetPreview::toggleDrawPreview()
{
		...
		{
			mApexRenderDebug->setDrawGroupVisible((physx::PxI32)mDrawGroupIconScaled, true);
		}
		else
		{
			mApexRenderDebug->setDrawGroupVisible((physx::PxI32)mDrawGroupIconScaled, false);
		}
}
...
ForceFieldAssetPreview::~ForceFieldAssetPreview(void)
{
	if (mApexRenderDebug)
	{
		mApexRenderDebug->reset((physx::PxI32)mDrawGroupIconScaled);
		mApexRenderDebug->reset((physx::PxI32)mDrawGroupCylinder);
