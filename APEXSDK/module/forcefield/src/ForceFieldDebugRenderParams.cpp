...
const char* const ForceFieldDebugRenderParamsFactory::vptr =
    NxParameterized::getVptr<ForceFieldDebugRenderParams, ForceFieldDebugRenderParams::ClassAlignment>();
...
NxParameterized::MutexType ForceFieldDebugRenderParams::mBuiltFlagMutex;

ForceFieldDebugRenderParams::ForceFieldDebugRenderParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ForceFieldDebugRenderParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ForceFieldDebugRenderParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ForceFieldDebugRenderParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ForceFieldDebugRenderParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldDebugRenderParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
