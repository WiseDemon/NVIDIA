...
const char* const ForceFieldModuleParamsFactory::vptr =
    NxParameterized::getVptr<ForceFieldModuleParams, ForceFieldModuleParams::ClassAlignment>();
...
NxParameterized::MutexType ForceFieldModuleParams::mBuiltFlagMutex;

ForceFieldModuleParams::ForceFieldModuleParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ForceFieldModuleParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ForceFieldModuleParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ForceFieldModuleParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ForceFieldModuleParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldModuleParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
