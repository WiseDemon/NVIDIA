...
static const physx::PxU32 checksum[] = { 0x3c8f0dec, 0x042ae5c4, 0xd5557fc3, 0x0c637e85, };

} // namespace ForceFieldModuleParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ForceFieldModuleParams : public NxParameterized::NxParameters, public ForceFieldModuleParamsNS::ParametersStruct
{
public:
	ForceFieldModuleParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ForceFieldModuleParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ForceFieldModuleParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ForceFieldModuleParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ForceFieldModuleParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ForceFieldModuleParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ForceFieldModuleParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ForceFieldModuleParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ForceFieldModuleParams");
			return 0;
		}
