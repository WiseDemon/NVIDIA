...
static const physx::PxU32 checksum[] = { 0x6c2d91a1, 0xd148985c, 0xcfbee3bb, 0xefb2f190, };

} // namespace ForceFieldFalloffParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ForceFieldFalloffParams : public NxParameterized::NxParameters, public ForceFieldFalloffParamsNS::ParametersStruct
{
public:
	ForceFieldFalloffParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ForceFieldFalloffParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ForceFieldFalloffParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ForceFieldFalloffParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ForceFieldFalloffParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ForceFieldFalloffParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ForceFieldFalloffParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ForceFieldFalloffParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ForceFieldFalloffParams");
			return 0;
		}
