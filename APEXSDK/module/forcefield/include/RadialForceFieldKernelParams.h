...
struct ParametersStruct
{
	...
	NxParameterized::Interface* falloffParameters;
	NxParameterized::Interface* noiseParameters;
	physx::PxF32 radius;

};

static const physx::PxU32 checksum[] = { 0xa0410ec7, 0x17712202, 0x427b07d4, 0xa8ce4d70, };

} // namespace RadialForceFieldKernelParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class RadialForceFieldKernelParams : public NxParameterized::NxParameters, public RadialForceFieldKernelParamsNS::ParametersStruct
{
public:
	RadialForceFieldKernelParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class RadialForceFieldKernelParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, RadialForceFieldKernelParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RadialForceFieldKernelParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(RadialForceFieldKernelParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, RadialForceFieldKernelParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, RadialForceFieldKernelParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, RadialForceFieldKernelParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RadialForceFieldKernelParams");
			return 0;
		}
