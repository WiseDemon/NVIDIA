...
static const physx::PxU32 checksum[] = { 0xe1b8703d, 0x1fdfe32b, 0xdfd01cd1, 0x8ba595b4, };

} // namespace ForceFieldDebugRenderParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ForceFieldDebugRenderParams : public NxParameterized::NxParameters, public ForceFieldDebugRenderParamsNS::ParametersStruct
{
public:
	ForceFieldDebugRenderParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ForceFieldDebugRenderParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ForceFieldDebugRenderParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ForceFieldDebugRenderParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ForceFieldDebugRenderParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ForceFieldDebugRenderParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ForceFieldDebugRenderParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ForceFieldDebugRenderParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ForceFieldDebugRenderParams");
			return 0;
		}
