...
const char* const BasicIOSAssetParamFactory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam, BasicIOSAssetParam::ClassAlignment>();
...
NxParameterized::MutexType BasicIOSAssetParam::mBuiltFlagMutex;

BasicIOSAssetParam::BasicIOSAssetParam(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
