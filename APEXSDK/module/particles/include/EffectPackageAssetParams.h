...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EffectPackageAssetParams : public NxParameterized::NxParameters, public EffectPackageAssetParamsNS::ParametersStruct
{
public:
	EffectPackageAssetParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EffectPackageAssetParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EffectPackageAssetParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageAssetParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(EffectPackageAssetParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, EffectPackageAssetParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EffectPackageAssetParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EffectPackageAssetParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageAssetParams");
			return 0;
		}
