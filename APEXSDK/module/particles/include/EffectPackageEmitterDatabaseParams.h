...
static const physx::PxU32 checksum[] = { 0x03542e55, 0x98562f65, 0x397b5760, 0xc62eb3f2, };

} // namespace EffectPackageEmitterDatabaseParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EffectPackageEmitterDatabaseParams : public NxParameterized::NxParameters, public EffectPackageEmitterDatabaseParamsNS::ParametersStruct
{
public:
	EffectPackageEmitterDatabaseParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EffectPackageEmitterDatabaseParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EffectPackageEmitterDatabaseParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageEmitterDatabaseParams");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, EffectPackageEmitterDatabaseParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EffectPackageEmitterDatabaseParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EffectPackageEmitterDatabaseParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageEmitterDatabaseParams");
			return 0;
		}
