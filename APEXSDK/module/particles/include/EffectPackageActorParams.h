...
struct ParametersStruct
{
	...
	physx::PxF32 objectScale;
	bool Enabled;

};

static const physx::PxU32 checksum[] = { 0xb5e9f529, 0x94a2ff3d, 0x5955c2b8, 0x14b06ba4, };

} // namespace EffectPackageActorParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EffectPackageActorParams : public NxParameterized::NxParameters, public EffectPackageActorParamsNS::ParametersStruct
{
public:
	EffectPackageActorParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EffectPackageActorParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EffectPackageActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageActorParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(EffectPackageActorParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, EffectPackageActorParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EffectPackageActorParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EffectPackageActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageActorParams");
			return 0;
		}
