...
struct ParametersStruct
{
	...
	NxParameterized::Interface* EffectPackage;

};

static const physx::PxU32 checksum[] = { 0x5f619c90, 0xacc5a650, 0x66393099, 0x47b4a900, };

} // namespace EffectPackageDataNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EffectPackageData : public NxParameterized::NxParameters, public EffectPackageDataNS::ParametersStruct
{
public:
	EffectPackageData(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EffectPackageDataFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EffectPackageData::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageData");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(EffectPackageData)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, EffectPackageData)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EffectPackageData::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EffectPackageData::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageData");
			return 0;
		}
