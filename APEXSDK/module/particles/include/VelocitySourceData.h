...
static const physx::PxU32 checksum[] = { 0x1d529c10, 0x109f65ed, 0xa3531c3a, 0x99ada8f2, };

} // namespace VelocitySourceDataNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class VelocitySourceData : public NxParameterized::NxParameters, public VelocitySourceDataNS::ParametersStruct
{
public:
	VelocitySourceData(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class VelocitySourceDataFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, VelocitySourceData::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VelocitySourceData");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(VelocitySourceData)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, VelocitySourceData)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, VelocitySourceData::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, VelocitySourceData::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VelocitySourceData");
			return 0;
		}
