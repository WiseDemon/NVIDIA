...
static const physx::PxU32 checksum[] = { 0x2d879f87, 0x7b8f475b, 0xd42bfe31, 0x27efcd68, };

} // namespace EffectPackageGraphicsMaterialsParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EffectPackageGraphicsMaterialsParams : public NxParameterized::NxParameters, public EffectPackageGraphicsMaterialsParamsNS::ParametersStruct
{
public:
	EffectPackageGraphicsMaterialsParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EffectPackageGraphicsMaterialsParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EffectPackageGraphicsMaterialsParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageGraphicsMaterialsParams");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, EffectPackageGraphicsMaterialsParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EffectPackageGraphicsMaterialsParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EffectPackageGraphicsMaterialsParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageGraphicsMaterialsParams");
			return 0;
		}
