...
static const physx::PxU32 checksum[] = { 0xad0ce7f8, 0x2fb85c3b, 0x5bd65a2b, 0x570e1992, };

} // namespace AttractorFieldSamplerDataNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class AttractorFieldSamplerData : public NxParameterized::NxParameters, public AttractorFieldSamplerDataNS::ParametersStruct
{
public:
	AttractorFieldSamplerData(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class AttractorFieldSamplerDataFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, AttractorFieldSamplerData::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class AttractorFieldSamplerData");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(AttractorFieldSamplerData)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, AttractorFieldSamplerData)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, AttractorFieldSamplerData::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, AttractorFieldSamplerData::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class AttractorFieldSamplerData");
			return 0;
		}
