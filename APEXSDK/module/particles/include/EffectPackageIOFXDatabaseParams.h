...
static const physx::PxU32 checksum[] = { 0x012bd755, 0x3845c426, 0x155f44aa, 0xeba55527, };

} // namespace EffectPackageIOFXDatabaseParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class EffectPackageIOFXDatabaseParams : public NxParameterized::NxParameters, public EffectPackageIOFXDatabaseParamsNS::ParametersStruct
{
public:
	EffectPackageIOFXDatabaseParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class EffectPackageIOFXDatabaseParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, EffectPackageIOFXDatabaseParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageIOFXDatabaseParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(EffectPackageIOFXDatabaseParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, EffectPackageIOFXDatabaseParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, EffectPackageIOFXDatabaseParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, EffectPackageIOFXDatabaseParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class EffectPackageIOFXDatabaseParams");
			return 0;
		}
