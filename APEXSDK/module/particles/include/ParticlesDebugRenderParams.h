...
static const physx::PxU32 checksum[] = { 0x85e707bb, 0x319491d5, 0x1be4a6e4, 0x78bfbdf4, };

} // namespace ParticlesDebugRenderParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ParticlesDebugRenderParams : public NxParameterized::NxParameters, public ParticlesDebugRenderParamsNS::ParametersStruct
{
public:
	ParticlesDebugRenderParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ParticlesDebugRenderParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ParticlesDebugRenderParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ParticlesDebugRenderParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ParticlesDebugRenderParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ParticlesDebugRenderParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ParticlesDebugRenderParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ParticlesDebugRenderParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ParticlesDebugRenderParams");
			return 0;
		}
