...
struct ParametersStruct
{
	...
	NxParameterized::Interface* SubstanceSource;

};

static const physx::PxU32 checksum[] = { 0x171c45ff, 0xd18f749a, 0xeaca4f46, 0xec9ce317, };

} // namespace SubstanceSourceEffectNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class SubstanceSourceEffect : public NxParameterized::NxParameters, public SubstanceSourceEffectNS::ParametersStruct
{
public:
	SubstanceSourceEffect(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class SubstanceSourceEffectFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, SubstanceSourceEffect::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SubstanceSourceEffect");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(SubstanceSourceEffect)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, SubstanceSourceEffect)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, SubstanceSourceEffect::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, SubstanceSourceEffect::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SubstanceSourceEffect");
			return 0;
		}
