...
const char* const RigidBodyEffectFactory::vptr =
    NxParameterized::getVptr<RigidBodyEffect, RigidBodyEffect::ClassAlignment>();

const physx::PxU32 NumParamDefs = 41;
...
NxParameterized::MutexType RigidBodyEffect::mBuiltFlagMutex;

RigidBodyEffect::RigidBodyEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RigidBodyEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RigidBodyEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RigidBodyEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RigidBodyEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RigidBodyEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void RigidBodyEffect::initDefaults(void)
{
	...
	LinearDamping = physx::PxF32(0.000000000);
	AngularDamping = physx::PxF32(0.000000000);
