...
const char* const VortexFieldSamplerEffectFactory::vptr =
    NxParameterized::getVptr<VortexFieldSamplerEffect, VortexFieldSamplerEffect::ClassAlignment>();
...
NxParameterized::MutexType VortexFieldSamplerEffect::mBuiltFlagMutex;

VortexFieldSamplerEffect::VortexFieldSamplerEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* VortexFieldSamplerEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* VortexFieldSamplerEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType VortexFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType VortexFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VortexFieldSamplerEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
