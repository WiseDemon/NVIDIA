...
const char* const ParticlesDebugRenderParamsFactory::vptr =
    NxParameterized::getVptr<ParticlesDebugRenderParams, ParticlesDebugRenderParams::ClassAlignment>();
...
NxParameterized::MutexType ParticlesDebugRenderParams::mBuiltFlagMutex;

ParticlesDebugRenderParams::ParticlesDebugRenderParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ParticlesDebugRenderParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticlesDebugRenderParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ParticlesDebugRenderParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticlesDebugRenderParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticlesDebugRenderParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
