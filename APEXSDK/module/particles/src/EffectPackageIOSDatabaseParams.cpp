...
const char* const EffectPackageIOSDatabaseParamsFactory::vptr =
    NxParameterized::getVptr<EffectPackageIOSDatabaseParams, EffectPackageIOSDatabaseParams::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // ParticleSimulations[]
};


bool EffectPackageIOSDatabaseParams::mBuiltFlag = false;
NxParameterized::MutexType EffectPackageIOSDatabaseParams::mBuiltFlagMutex;

EffectPackageIOSDatabaseParams::EffectPackageIOSDatabaseParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EffectPackageIOSDatabaseParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EffectPackageIOSDatabaseParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EffectPackageIOSDatabaseParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EffectPackageIOSDatabaseParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EffectPackageIOSDatabaseParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void EffectPackageIOSDatabaseParams::initDynamicArrays(void)
{
	...
	ParticleSimulations.elementSize = sizeof(NxParameterized::Interface*);
