...
const char* const ParticlesModuleParametersFactory::vptr =
    NxParameterized::getVptr<ParticlesModuleParameters, ParticlesModuleParameters::ClassAlignment>();
...
NxParameterized::MutexType ParticlesModuleParameters::mBuiltFlagMutex;

ParticlesModuleParameters::ParticlesModuleParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ParticlesModuleParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticlesModuleParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ParticlesModuleParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticlesModuleParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticlesModuleParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ParticlesModuleParameters::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=0, longName=""
	{
		...
		HintTable[0].init("shortDescription", "This class is used for initializing the NxModuleParticles.", true);
