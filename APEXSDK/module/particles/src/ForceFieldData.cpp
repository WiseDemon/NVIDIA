...
const char* const ForceFieldDataFactory::vptr =
    NxParameterized::getVptr<ForceFieldData, ForceFieldData::ClassAlignment>();
...
NxParameterized::MutexType ForceFieldData::mBuiltFlagMutex;

ForceFieldData::ForceFieldData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ForceFieldData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ForceFieldData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ForceFieldData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ForceFieldData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
