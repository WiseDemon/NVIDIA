...
const char* const GraphicsMaterialDataFactory::vptr =
    NxParameterized::getVptr<GraphicsMaterialData, GraphicsMaterialData::ClassAlignment>();
...
NxParameterized::MutexType GraphicsMaterialData::mBuiltFlagMutex;

GraphicsMaterialData::GraphicsMaterialData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType GraphicsMaterialData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType GraphicsMaterialData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GraphicsMaterialData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
