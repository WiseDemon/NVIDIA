...
const char* const WindFieldSamplerDataFactory::vptr =
    NxParameterized::getVptr<WindFieldSamplerData, WindFieldSamplerData::ClassAlignment>();
...
NxParameterized::MutexType WindFieldSamplerData::mBuiltFlagMutex;

WindFieldSamplerData::WindFieldSamplerData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* WindFieldSamplerData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* WindFieldSamplerData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType WindFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType WindFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void WindFieldSamplerData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
