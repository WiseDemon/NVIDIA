...
const char* const HeatSourceEffectFactory::vptr =
    NxParameterized::getVptr<HeatSourceEffect, HeatSourceEffect::ClassAlignment>();
...
NxParameterized::MutexType HeatSourceEffect::mBuiltFlagMutex;

HeatSourceEffect::HeatSourceEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* HeatSourceEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* HeatSourceEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType HeatSourceEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType HeatSourceEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void HeatSourceEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
