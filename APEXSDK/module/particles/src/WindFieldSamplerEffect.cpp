...
const char* const WindFieldSamplerEffectFactory::vptr =
    NxParameterized::getVptr<WindFieldSamplerEffect, WindFieldSamplerEffect::ClassAlignment>();
...
NxParameterized::MutexType WindFieldSamplerEffect::mBuiltFlagMutex;

WindFieldSamplerEffect::WindFieldSamplerEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* WindFieldSamplerEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* WindFieldSamplerEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType WindFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType WindFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void WindFieldSamplerEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
