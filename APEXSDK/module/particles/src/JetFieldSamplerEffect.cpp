...
const char* const JetFieldSamplerEffectFactory::vptr =
    NxParameterized::getVptr<JetFieldSamplerEffect, JetFieldSamplerEffect::ClassAlignment>();
...
NxParameterized::MutexType JetFieldSamplerEffect::mBuiltFlagMutex;

JetFieldSamplerEffect::JetFieldSamplerEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* JetFieldSamplerEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* JetFieldSamplerEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType JetFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType JetFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFieldSamplerEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
