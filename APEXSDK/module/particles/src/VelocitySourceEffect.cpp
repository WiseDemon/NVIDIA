...
const char* const VelocitySourceEffectFactory::vptr =
    NxParameterized::getVptr<VelocitySourceEffect, VelocitySourceEffect::ClassAlignment>();
...
NxParameterized::MutexType VelocitySourceEffect::mBuiltFlagMutex;

VelocitySourceEffect::VelocitySourceEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* VelocitySourceEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* VelocitySourceEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType VelocitySourceEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType VelocitySourceEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VelocitySourceEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
