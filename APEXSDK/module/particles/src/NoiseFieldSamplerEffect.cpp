...
const char* const NoiseFieldSamplerEffectFactory::vptr =
    NxParameterized::getVptr<NoiseFieldSamplerEffect, NoiseFieldSamplerEffect::ClassAlignment>();
...
NxParameterized::MutexType NoiseFieldSamplerEffect::mBuiltFlagMutex;

NoiseFieldSamplerEffect::NoiseFieldSamplerEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* NoiseFieldSamplerEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* NoiseFieldSamplerEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType NoiseFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType NoiseFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFieldSamplerEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
