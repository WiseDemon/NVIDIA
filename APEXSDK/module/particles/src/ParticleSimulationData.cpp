...
const char* const ParticleSimulationDataFactory::vptr =
    NxParameterized::getVptr<ParticleSimulationData, ParticleSimulationData::ClassAlignment>();
...
NxParameterized::MutexType ParticleSimulationData::mBuiltFlagMutex;

ParticleSimulationData::ParticleSimulationData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ParticleSimulationData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticleSimulationData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ParticleSimulationData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticleSimulationData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleSimulationData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
