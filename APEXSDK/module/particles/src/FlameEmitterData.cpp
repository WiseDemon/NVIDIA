...
const char* const FlameEmitterDataFactory::vptr =
    NxParameterized::getVptr<FlameEmitterData, FlameEmitterData::ClassAlignment>();
...
NxParameterized::MutexType FlameEmitterData::mBuiltFlagMutex;

FlameEmitterData::FlameEmitterData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* FlameEmitterData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* FlameEmitterData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType FlameEmitterData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType FlameEmitterData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void FlameEmitterData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
