...
const char* const JetFieldSamplerDataFactory::vptr =
    NxParameterized::getVptr<JetFieldSamplerData, JetFieldSamplerData::ClassAlignment>();
...
NxParameterized::MutexType JetFieldSamplerData::mBuiltFlagMutex;

JetFieldSamplerData::JetFieldSamplerData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* JetFieldSamplerData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* JetFieldSamplerData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType JetFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType JetFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFieldSamplerData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
