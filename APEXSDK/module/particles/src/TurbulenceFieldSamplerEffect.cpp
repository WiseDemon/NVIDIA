...
const char* const TurbulenceFieldSamplerEffectFactory::vptr =
    NxParameterized::getVptr<TurbulenceFieldSamplerEffect, TurbulenceFieldSamplerEffect::ClassAlignment>();
...
NxParameterized::MutexType TurbulenceFieldSamplerEffect::mBuiltFlagMutex;

TurbulenceFieldSamplerEffect::TurbulenceFieldSamplerEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFieldSamplerEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFieldSamplerEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFieldSamplerEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
