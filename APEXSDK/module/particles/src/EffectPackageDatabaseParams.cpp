...
const char* const EffectPackageDatabaseParamsFactory::vptr =
    NxParameterized::getVptr<EffectPackageDatabaseParams, EffectPackageDatabaseParams::ClassAlignment>();
...
NxParameterized::MutexType EffectPackageDatabaseParams::mBuiltFlagMutex;

EffectPackageDatabaseParams::EffectPackageDatabaseParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EffectPackageDatabaseParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EffectPackageDatabaseParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EffectPackageDatabaseParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EffectPackageDatabaseParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EffectPackageDatabaseParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
