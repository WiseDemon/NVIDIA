...
const char* const AttractorFieldSamplerEffectFactory::vptr =
    NxParameterized::getVptr<AttractorFieldSamplerEffect, AttractorFieldSamplerEffect::ClassAlignment>();
...
NxParameterized::MutexType AttractorFieldSamplerEffect::mBuiltFlagMutex;

AttractorFieldSamplerEffect::AttractorFieldSamplerEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* AttractorFieldSamplerEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* AttractorFieldSamplerEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType AttractorFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType AttractorFieldSamplerEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFieldSamplerEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
