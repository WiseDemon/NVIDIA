...
const char* const AttractorFieldSamplerDataFactory::vptr =
    NxParameterized::getVptr<AttractorFieldSamplerData, AttractorFieldSamplerData::ClassAlignment>();
...
NxParameterized::MutexType AttractorFieldSamplerData::mBuiltFlagMutex;

AttractorFieldSamplerData::AttractorFieldSamplerData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* AttractorFieldSamplerData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* AttractorFieldSamplerData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType AttractorFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType AttractorFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFieldSamplerData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
