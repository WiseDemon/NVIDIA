...
const char* const FlameEmitterEffectFactory::vptr =
    NxParameterized::getVptr<FlameEmitterEffect, FlameEmitterEffect::ClassAlignment>();
...
NxParameterized::MutexType FlameEmitterEffect::mBuiltFlagMutex;

FlameEmitterEffect::FlameEmitterEffect(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* FlameEmitterEffect::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* FlameEmitterEffect::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType FlameEmitterEffect::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType FlameEmitterEffect::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void FlameEmitterEffect::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
