...
const char* const EffectPackageIOFXDatabaseParamsFactory::vptr =
    NxParameterized::getVptr<EffectPackageIOFXDatabaseParams, EffectPackageIOFXDatabaseParams::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_REF, false, 1 * sizeof(NxParameterized::Interface*), NULL, 0 }, // GraphicsEffects[]
};


bool EffectPackageIOFXDatabaseParams::mBuiltFlag = false;
NxParameterized::MutexType EffectPackageIOFXDatabaseParams::mBuiltFlagMutex;

EffectPackageIOFXDatabaseParams::EffectPackageIOFXDatabaseParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EffectPackageIOFXDatabaseParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EffectPackageIOFXDatabaseParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EffectPackageIOFXDatabaseParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EffectPackageIOFXDatabaseParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EffectPackageIOFXDatabaseParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void EffectPackageIOFXDatabaseParams::initDynamicArrays(void)
{
	...
	GraphicsEffects.elementSize = sizeof(NxParameterized::Interface*);
