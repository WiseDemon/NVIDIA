...
const char* const VortexFieldSamplerDataFactory::vptr =
    NxParameterized::getVptr<VortexFieldSamplerData, VortexFieldSamplerData::ClassAlignment>();
...
NxParameterized::MutexType VortexFieldSamplerData::mBuiltFlagMutex;

VortexFieldSamplerData::VortexFieldSamplerData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* VortexFieldSamplerData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* VortexFieldSamplerData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType VortexFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType VortexFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VortexFieldSamplerData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
