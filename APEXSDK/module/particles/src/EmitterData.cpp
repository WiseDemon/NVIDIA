...
const char* const EmitterDataFactory::vptr =
    NxParameterized::getVptr<EmitterData, EmitterData::ClassAlignment>();
...
NxParameterized::MutexType EmitterData::mBuiltFlagMutex;

EmitterData::EmitterData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EmitterData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EmitterData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EmitterData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EmitterData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EmitterData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
