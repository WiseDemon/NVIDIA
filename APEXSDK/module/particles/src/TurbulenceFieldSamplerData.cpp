...
const char* const TurbulenceFieldSamplerDataFactory::vptr =
    NxParameterized::getVptr<TurbulenceFieldSamplerData, TurbulenceFieldSamplerData::ClassAlignment>();
...
NxParameterized::MutexType TurbulenceFieldSamplerData::mBuiltFlagMutex;

TurbulenceFieldSamplerData::TurbulenceFieldSamplerData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFieldSamplerData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFieldSamplerData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFieldSamplerData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
