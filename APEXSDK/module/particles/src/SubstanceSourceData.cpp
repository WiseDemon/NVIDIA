...
const char* const SubstanceSourceDataFactory::vptr =
    NxParameterized::getVptr<SubstanceSourceData, SubstanceSourceData::ClassAlignment>();
...
NxParameterized::MutexType SubstanceSourceData::mBuiltFlagMutex;

SubstanceSourceData::SubstanceSourceData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SubstanceSourceData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SubstanceSourceData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SubstanceSourceData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SubstanceSourceData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SubstanceSourceData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
