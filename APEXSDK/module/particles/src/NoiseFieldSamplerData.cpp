...
const char* const NoiseFieldSamplerDataFactory::vptr =
    NxParameterized::getVptr<NoiseFieldSamplerData, NoiseFieldSamplerData::ClassAlignment>();
...
NxParameterized::MutexType NoiseFieldSamplerData::mBuiltFlagMutex;

NoiseFieldSamplerData::NoiseFieldSamplerData(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* NoiseFieldSamplerData::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* NoiseFieldSamplerData::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType NoiseFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType NoiseFieldSamplerData::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFieldSamplerData::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
