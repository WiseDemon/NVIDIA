...
const char* const TurbulenceFSAssetParams_1p0Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_1p0, TurbulenceFSAssetParams_1p0::ClassAlignment>();

const physx::PxU32 NumParamDefs = 61;
...
NxParameterized::MutexType TurbulenceFSAssetParams_1p0::mBuiltFlagMutex;

TurbulenceFSAssetParams_1p0::TurbulenceFSAssetParams_1p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_1p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
