...
const char* const TurbulenceFSAssetParams_1p1Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_1p1, TurbulenceFSAssetParams_1p1::ClassAlignment>();

const physx::PxU32 NumParamDefs = 62;
...
NxParameterized::MutexType TurbulenceFSAssetParams_1p1::mBuiltFlagMutex;

TurbulenceFSAssetParams_1p1::TurbulenceFSAssetParams_1p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_1p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void TurbulenceFSAssetParams_1p1::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=21, longName="velocityFieldCleaningIntensity"
	{
		...
		static HintImpl HintTable[2];
		static Hint* HintPtrTable[2] = { &HintTable[0], &HintTable[1], };
		HintTable[0].init("max", physx::PxU64(4), true);
	...
	// Initialize DefinitionImpl node: nodeIndex=44, longName="densityParams.densityFieldFade"
	{
		...
		ParamDefTable[44].setHints((const NxParameterized::Hint**)HintPtrTable, 3);
	...
	// Initialize DefinitionImpl node: nodeIndex=53, longName="lodWeights.benefitWeight"
	{
		...
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("shortDescription", "benefit = ((distanceWeight * distanceFactor + bias) * SimulationCost + benefitBias) * benefitWeight", true);
		ParamDefTable[53].setHints((const NxParameterized::Hint**)HintPtrTable, 1);
...
void TurbulenceFSAssetParams_1p1::initDefaults(void)
{
	...
	velocityFieldFade = physx::PxF32(0);
	velocityFieldCleaningTime = physx::PxF32(0);
	velocityFieldCleaningDelay = physx::PxF32(2);
	velocityFieldCleaningIntensity = physx::PxF32(2);
