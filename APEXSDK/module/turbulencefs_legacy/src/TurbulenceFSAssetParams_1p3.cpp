...
const char* const TurbulenceFSAssetParams_1p3Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_1p3, TurbulenceFSAssetParams_1p3::ClassAlignment>();
...
NxParameterized::MutexType TurbulenceFSAssetParams_1p3::mBuiltFlagMutex;

TurbulenceFSAssetParams_1p3::TurbulenceFSAssetParams_1p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_1p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
