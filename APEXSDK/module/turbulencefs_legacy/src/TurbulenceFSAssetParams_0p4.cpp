...
const char* const TurbulenceFSAssetParams_0p4Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_0p4, TurbulenceFSAssetParams_0p4::ClassAlignment>();
...
NxParameterized::MutexType TurbulenceFSAssetParams_0p4::mBuiltFlagMutex;

TurbulenceFSAssetParams_0p4::TurbulenceFSAssetParams_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p4::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
