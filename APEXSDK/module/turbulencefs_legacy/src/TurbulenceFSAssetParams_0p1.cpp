...
const char* const TurbulenceFSAssetParams_0p1Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_0p1, TurbulenceFSAssetParams_0p1::ClassAlignment>();

const physx::PxU32 NumParamDefs = 49;
...
NxParameterized::MutexType TurbulenceFSAssetParams_0p1::mBuiltFlagMutex;

TurbulenceFSAssetParams_0p1::TurbulenceFSAssetParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
