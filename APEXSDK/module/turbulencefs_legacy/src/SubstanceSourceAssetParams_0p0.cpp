...
const char* const SubstanceSourceAssetParams_0p0Factory::vptr =
    NxParameterized::getVptr<SubstanceSourceAssetParams_0p0, SubstanceSourceAssetParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType SubstanceSourceAssetParams_0p0::mBuiltFlagMutex;

SubstanceSourceAssetParams_0p0::SubstanceSourceAssetParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SubstanceSourceAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SubstanceSourceAssetParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SubstanceSourceAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SubstanceSourceAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SubstanceSourceAssetParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
