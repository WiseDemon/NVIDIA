...
const char* const HeatSourceAssetParams_0p1Factory::vptr =
    NxParameterized::getVptr<HeatSourceAssetParams_0p1, HeatSourceAssetParams_0p1::ClassAlignment>();
...
NxParameterized::MutexType HeatSourceAssetParams_0p1::mBuiltFlagMutex;

HeatSourceAssetParams_0p1::HeatSourceAssetParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* HeatSourceAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* HeatSourceAssetParams_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType HeatSourceAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType HeatSourceAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void HeatSourceAssetParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
