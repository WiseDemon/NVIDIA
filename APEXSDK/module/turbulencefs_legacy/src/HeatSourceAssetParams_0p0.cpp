...
const char* const HeatSourceAssetParams_0p0Factory::vptr =
    NxParameterized::getVptr<HeatSourceAssetParams_0p0, HeatSourceAssetParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType HeatSourceAssetParams_0p0::mBuiltFlagMutex;

HeatSourceAssetParams_0p0::HeatSourceAssetParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* HeatSourceAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* HeatSourceAssetParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType HeatSourceAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType HeatSourceAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void HeatSourceAssetParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
