...
const char* const TurbulenceFSAssetParams_0p9Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_0p9, TurbulenceFSAssetParams_0p9::ClassAlignment>();
...
NxParameterized::MutexType TurbulenceFSAssetParams_0p9::mBuiltFlagMutex;

TurbulenceFSAssetParams_0p9::TurbulenceFSAssetParams_0p9(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p9::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p9::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p9::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p9::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_0p9::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
