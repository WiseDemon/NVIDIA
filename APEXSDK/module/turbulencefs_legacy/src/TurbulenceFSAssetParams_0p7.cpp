...
const char* const TurbulenceFSAssetParams_0p7Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_0p7, TurbulenceFSAssetParams_0p7::ClassAlignment>();

const physx::PxU32 NumParamDefs = 59;
...
NxParameterized::MutexType TurbulenceFSAssetParams_0p7::mBuiltFlagMutex;

TurbulenceFSAssetParams_0p7::TurbulenceFSAssetParams_0p7(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p7::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_0p7::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p7::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_0p7::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_0p7::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
