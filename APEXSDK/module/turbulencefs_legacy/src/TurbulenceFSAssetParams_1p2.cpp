...
const char* const TurbulenceFSAssetParams_1p2Factory::vptr =
    NxParameterized::getVptr<TurbulenceFSAssetParams_1p2, TurbulenceFSAssetParams_1p2::ClassAlignment>();
...
NxParameterized::MutexType TurbulenceFSAssetParams_1p2::mBuiltFlagMutex;

TurbulenceFSAssetParams_1p2::TurbulenceFSAssetParams_1p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* TurbulenceFSAssetParams_1p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType TurbulenceFSAssetParams_1p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void TurbulenceFSAssetParams_1p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
