...
#ifndef HEADER_TurbulenceFSAssetParams_1p4_h
#define HEADER_TurbulenceFSAssetParams_1p4_h
...
namespace TurbulenceFSAssetParams_1p4NS
{
...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class TurbulenceFSAssetParams_1p4 : public NxParameterized::NxParameters, public TurbulenceFSAssetParams_1p4NS::ParametersStruct
{
public:
	TurbulenceFSAssetParams_1p4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);

	virtual ~TurbulenceFSAssetParams_1p4();
	...
	{
		bits = 8 * sizeof(TurbulenceFSAssetParams_1p4NS::checksum);
		return TurbulenceFSAssetParams_1p4NS::checksum;
	}
	...
	const TurbulenceFSAssetParams_1p4NS::ParametersStruct& parameters(void) const
	{
		TurbulenceFSAssetParams_1p4* tmpThis = const_cast<TurbulenceFSAssetParams_1p4*>(this);
		return *(static_cast<TurbulenceFSAssetParams_1p4NS::ParametersStruct*>(tmpThis));
	}

	TurbulenceFSAssetParams_1p4NS::ParametersStruct& parameters(void)
	{
		return *(static_cast<TurbulenceFSAssetParams_1p4NS::ParametersStruct*>(this));
	}
...
class TurbulenceFSAssetParams_1p4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		void* newPtr = paramTraits->alloc(sizeof(TurbulenceFSAssetParams_1p4), TurbulenceFSAssetParams_1p4::ClassAlignment);
		if (!NxParameterized::IsAligned(newPtr, TurbulenceFSAssetParams_1p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSAssetParams_1p4");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(TurbulenceFSAssetParams_1p4)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, TurbulenceFSAssetParams_1p4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, TurbulenceFSAssetParams_1p4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, TurbulenceFSAssetParams_1p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSAssetParams_1p4");
			return 0;
		}
		...
		// We used to call empty constructor of TurbulenceFSAssetParams_1p4 here
		...
		*(const char**)bufObj = vptr;
		...
		return (TurbulenceFSAssetParams_1p4*)bufObj;
	}

	virtual const char* getClassName()
	{
		return (TurbulenceFSAssetParams_1p4::staticClassName());
	}

	virtual physx::PxU32 getVersion()
	{
		return (TurbulenceFSAssetParams_1p4::staticVersion());
	}

	virtual physx::PxU32 getAlignment()
	{
		return (TurbulenceFSAssetParams_1p4::ClassAlignment);
	}

	virtual const physx::PxU32* getChecksum(physx::PxU32& bits)
	{
		return (TurbulenceFSAssetParams_1p4::staticChecksum(bits));
	}
};
