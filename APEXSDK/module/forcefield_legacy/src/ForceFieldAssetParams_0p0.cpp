...
const char* const ForceFieldAssetParams_0p0Factory::vptr =
    NxParameterized::getVptr<ForceFieldAssetParams_0p0, ForceFieldAssetParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType ForceFieldAssetParams_0p0::mBuiltFlagMutex;

ForceFieldAssetParams_0p0::ForceFieldAssetParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ForceFieldAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ForceFieldAssetParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ForceFieldAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ForceFieldAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldAssetParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
