...
const char* const GenericForceFieldKernelParams_0p1Factory::vptr =
    NxParameterized::getVptr<GenericForceFieldKernelParams_0p1, GenericForceFieldKernelParams_0p1::ClassAlignment>();
...
NxParameterized::MutexType GenericForceFieldKernelParams_0p1::mBuiltFlagMutex;

GenericForceFieldKernelParams_0p1::GenericForceFieldKernelParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* GenericForceFieldKernelParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* GenericForceFieldKernelParams_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType GenericForceFieldKernelParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType GenericForceFieldKernelParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GenericForceFieldKernelParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void GenericForceFieldKernelParams_0p1::initDefaults(void)
{
	...
	velocityMultiplier = physx::PxMat33Legacy(init( 0, 0, 0, 0, 0, 0, 0, 0, 0));
