...
using namespace ForceFieldAssetParams_0p1NS;

const char* const ForceFieldAssetParams_0p1Factory::vptr =
    NxParameterized::getVptr<ForceFieldAssetParams_0p1, ForceFieldAssetParams_0p1::ClassAlignment>();
...
bool ForceFieldAssetParams_0p1::mBuiltFlag = false;
NxParameterized::MutexType ForceFieldAssetParams_0p1::mBuiltFlagMutex;

ForceFieldAssetParams_0p1::ForceFieldAssetParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ForceFieldAssetParams_0p1FactoryInst);
...
ForceFieldAssetParams_0p1::~ForceFieldAssetParams_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ForceFieldAssetParams_0p1::destroy()
{
	...
	this->~ForceFieldAssetParams_0p1();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ForceFieldAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ForceFieldAssetParams_0p1::getParameterDefinitionTree(void) const
{
	ForceFieldAssetParams_0p1* tmpParam = const_cast<ForceFieldAssetParams_0p1*>(this);
...
NxParameterized::ErrorType ForceFieldAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ForceFieldAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ForceFieldAssetParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ForceFieldAssetParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ForceFieldAssetParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ForceFieldAssetParams_0p1::buildTree(void)
{
...
void ForceFieldAssetParams_0p1::initStrings(void)
{
...
void ForceFieldAssetParams_0p1::initDynamicArrays(void)
{
}

void ForceFieldAssetParams_0p1::initDefaults(void)
{
...
void ForceFieldAssetParams_0p1::initReferences(void)
{
	forceFieldKernelType = NULL;

}

void ForceFieldAssetParams_0p1::freeDynamicArrays(void)
{
}

void ForceFieldAssetParams_0p1::freeStrings(void)
{
...
void ForceFieldAssetParams_0p1::freeReferences(void)
{
