...
struct ParametersStruct
{
	...
	physx::PxU32 maxRBCount;
	physx::PxU32 maxPSCount;
	physx::PxU32 maxParticleCount;

};

static const physx::PxU32 checksum[] = { 0x357a67e3, 0x9ed0cf4f, 0xd9fe5e4e, 0x532febb8, };

} // namespace FieldSamplerPhysXMonitorParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class FieldSamplerPhysXMonitorParams : public NxParameterized::NxParameters, public FieldSamplerPhysXMonitorParamsNS::ParametersStruct
{
public:
	FieldSamplerPhysXMonitorParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class FieldSamplerPhysXMonitorParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, FieldSamplerPhysXMonitorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class FieldSamplerPhysXMonitorParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(FieldSamplerPhysXMonitorParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, FieldSamplerPhysXMonitorParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, FieldSamplerPhysXMonitorParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, FieldSamplerPhysXMonitorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class FieldSamplerPhysXMonitorParams");
			return 0;
		}
