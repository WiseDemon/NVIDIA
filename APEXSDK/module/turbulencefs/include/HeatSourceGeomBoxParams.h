...
static const physx::PxU32 checksum[] = { 0x0f07e21e, 0x50b7ce3e, 0xaec748e4, 0x87b957bb, };

} // namespace HeatSourceGeomBoxParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class HeatSourceGeomBoxParams : public NxParameterized::NxParameters, public HeatSourceGeomBoxParamsNS::ParametersStruct
{
public:
	HeatSourceGeomBoxParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class HeatSourceGeomBoxParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, HeatSourceGeomBoxParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourceGeomBoxParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(HeatSourceGeomBoxParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, HeatSourceGeomBoxParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, HeatSourceGeomBoxParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, HeatSourceGeomBoxParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourceGeomBoxParams");
			return 0;
		}
