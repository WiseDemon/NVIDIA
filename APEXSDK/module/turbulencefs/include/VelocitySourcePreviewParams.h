...
static const physx::PxU32 checksum[] = { 0x66e552b1, 0x03902dc5, 0x59d4b6bc, 0xe07f1dcf, };

} // namespace VelocitySourcePreviewParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class VelocitySourcePreviewParams : public NxParameterized::NxParameters, public VelocitySourcePreviewParamsNS::ParametersStruct
{
public:
	VelocitySourcePreviewParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class VelocitySourcePreviewParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, VelocitySourcePreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VelocitySourcePreviewParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(VelocitySourcePreviewParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, VelocitySourcePreviewParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, VelocitySourcePreviewParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, VelocitySourcePreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VelocitySourcePreviewParams");
			return 0;
		}
