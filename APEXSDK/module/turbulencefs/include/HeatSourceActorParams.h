...
static const physx::PxU32 checksum[] = { 0x44e03473, 0x853ce1f7, 0x260e611e, 0xd4ad2f92, };

} // namespace HeatSourceActorParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class HeatSourceActorParams : public NxParameterized::NxParameters, public HeatSourceActorParamsNS::ParametersStruct
{
public:
	HeatSourceActorParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class HeatSourceActorParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, HeatSourceActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourceActorParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(HeatSourceActorParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, HeatSourceActorParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, HeatSourceActorParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, HeatSourceActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourceActorParams");
			return 0;
		}
