...
static const physx::PxU32 checksum[] = { 0x378dee9b, 0xc42849c6, 0x4d5f4bd8, 0x7324a6f1, };

} // namespace FlameEmitterPreviewParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class FlameEmitterPreviewParams : public NxParameterized::NxParameters, public FlameEmitterPreviewParamsNS::ParametersStruct
{
public:
	FlameEmitterPreviewParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class FlameEmitterPreviewParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, FlameEmitterPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class FlameEmitterPreviewParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(FlameEmitterPreviewParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, FlameEmitterPreviewParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, FlameEmitterPreviewParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, FlameEmitterPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class FlameEmitterPreviewParams");
			return 0;
		}
