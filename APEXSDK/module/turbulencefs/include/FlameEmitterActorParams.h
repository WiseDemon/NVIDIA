...
static const physx::PxU32 checksum[] = { 0x1d5ae264, 0xe1ac05ca, 0x4b6691ac, 0x9dbdfb9a, };

} // namespace FlameEmitterActorParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class FlameEmitterActorParams : public NxParameterized::NxParameters, public FlameEmitterActorParamsNS::ParametersStruct
{
public:
	FlameEmitterActorParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class FlameEmitterActorParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, FlameEmitterActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class FlameEmitterActorParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(FlameEmitterActorParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, FlameEmitterActorParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, FlameEmitterActorParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, FlameEmitterActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class FlameEmitterActorParams");
			return 0;
		}
