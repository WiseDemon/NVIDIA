...
static const physx::PxU32 checksum[] = { 0x56bc0afc, 0xa95be019, 0x8b31ee2b, 0xae912ded, };

} // namespace HeatSourcePreviewParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class HeatSourcePreviewParams : public NxParameterized::NxParameters, public HeatSourcePreviewParamsNS::ParametersStruct
{
public:
	HeatSourcePreviewParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class HeatSourcePreviewParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, HeatSourcePreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourcePreviewParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(HeatSourcePreviewParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, HeatSourcePreviewParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, HeatSourcePreviewParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, HeatSourcePreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourcePreviewParams");
			return 0;
		}
