...
static const physx::PxU32 checksum[] = { 0xfddbf878, 0xe3344a40, 0x42e09a65, 0x9039b9ab, };

} // namespace HeatSourceGeomSphereParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class HeatSourceGeomSphereParams : public NxParameterized::NxParameters, public HeatSourceGeomSphereParamsNS::ParametersStruct
{
public:
	HeatSourceGeomSphereParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class HeatSourceGeomSphereParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, HeatSourceGeomSphereParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourceGeomSphereParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(HeatSourceGeomSphereParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, HeatSourceGeomSphereParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, HeatSourceGeomSphereParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, HeatSourceGeomSphereParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class HeatSourceGeomSphereParams");
			return 0;
		}
