...
static const physx::PxU32 checksum[] = { 0x82906c60, 0xd45182d5, 0x780149e6, 0xeb2736fb, };

} // namespace TurbulenceFSModuleParametersNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class TurbulenceFSModuleParameters : public NxParameterized::NxParameters, public TurbulenceFSModuleParametersNS::ParametersStruct
{
public:
	TurbulenceFSModuleParameters(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class TurbulenceFSModuleParametersFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, TurbulenceFSModuleParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSModuleParameters");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(TurbulenceFSModuleParameters)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, TurbulenceFSModuleParameters)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, TurbulenceFSModuleParameters::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, TurbulenceFSModuleParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class TurbulenceFSModuleParameters");
			return 0;
		}
