...
const char* const ParticleIosModuleParametersFactory::vptr =
    NxParameterized::getVptr<ParticleIosModuleParameters, ParticleIosModuleParameters::ClassAlignment>();
...
NxParameterized::MutexType ParticleIosModuleParameters::mBuiltFlagMutex;

ParticleIosModuleParameters::ParticleIosModuleParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ParticleIosModuleParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticleIosModuleParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ParticleIosModuleParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticleIosModuleParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosModuleParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ParticleIosModuleParameters::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=0, longName=""
	{
		...
		HintTable[0].init("shortDescription", "This class is used for initializing the NxModuleParticleIos.", true);
