...
const char* const ParticleIosAssetParamFactory::vptr =
    NxParameterized::getVptr<ParticleIosAssetParam, ParticleIosAssetParam::ClassAlignment>();
...
NxParameterized::MutexType ParticleIosAssetParam::mBuiltFlagMutex;

ParticleIosAssetParam::ParticleIosAssetParam(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ParticleIosAssetParam::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticleIosAssetParam::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ParticleIosAssetParam::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticleIosAssetParam::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosAssetParam::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
