...
static const physx::PxU32 checksum[] = { 0x53933c71, 0xf953550b, 0x814f74ec, 0x33f15b05, };

} // namespace ParticleIosModuleParametersNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ParticleIosModuleParameters : public NxParameterized::NxParameters, public ParticleIosModuleParametersNS::ParametersStruct
{
public:
	ParticleIosModuleParameters(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ParticleIosModuleParametersFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ParticleIosModuleParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ParticleIosModuleParameters");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ParticleIosModuleParameters)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ParticleIosModuleParameters)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ParticleIosModuleParameters::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ParticleIosModuleParameters::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ParticleIosModuleParameters");
			return 0;
		}
