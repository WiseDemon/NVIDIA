...
const char* const SubmeshParameters_0p1Factory::vptr =
    NxParameterized::getVptr<SubmeshParameters_0p1, SubmeshParameters_0p1::ClassAlignment>();
...
NxParameterized::MutexType SubmeshParameters_0p1::mBuiltFlagMutex;

SubmeshParameters_0p1::SubmeshParameters_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SubmeshParameters_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SubmeshParameters_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SubmeshParameters_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SubmeshParameters_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SubmeshParameters_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
