...
using namespace VertexBufferParameters_0p0NS;

const char* const VertexBufferParameters_0p0Factory::vptr =
    NxParameterized::getVptr<VertexBufferParameters_0p0, VertexBufferParameters_0p0::ClassAlignment>();
...
bool VertexBufferParameters_0p0::mBuiltFlag = false;
NxParameterized::MutexType VertexBufferParameters_0p0::mBuiltFlagMutex;

VertexBufferParameters_0p0::VertexBufferParameters_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &VertexBufferParameters_0p0FactoryInst);
...
VertexBufferParameters_0p0::~VertexBufferParameters_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void VertexBufferParameters_0p0::destroy()
{
	...
	this->~VertexBufferParameters_0p0();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* VertexBufferParameters_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* VertexBufferParameters_0p0::getParameterDefinitionTree(void) const
{
	VertexBufferParameters_0p0* tmpParam = const_cast<VertexBufferParameters_0p0*>(this);
...
NxParameterized::ErrorType VertexBufferParameters_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType VertexBufferParameters_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VertexBufferParameters_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<VertexBufferParameters_0p0::ParametersStruct*>(&parameters()), handle, offset);
}
...
void VertexBufferParameters_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void VertexBufferParameters_0p0::initStrings(void)
{
}

void VertexBufferParameters_0p0::initDynamicArrays(void)
{
	buffers.buf = NULL;
...
void VertexBufferParameters_0p0::initDefaults(void)
{
...
void VertexBufferParameters_0p0::initReferences(void)
{
	vertexFormat = NULL;

}

void VertexBufferParameters_0p0::freeDynamicArrays(void)
{
...
void VertexBufferParameters_0p0::freeStrings(void)
{
}

void VertexBufferParameters_0p0::freeReferences(void)
{
	if (vertexFormat)
	{
