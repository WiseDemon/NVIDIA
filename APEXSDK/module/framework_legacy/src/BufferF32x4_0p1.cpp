...
const char* const BufferF32x4_0p1Factory::vptr =
    NxParameterized::getVptr<BufferF32x4_0p1, BufferF32x4_0p1::ClassAlignment>();
...
NxParameterized::MutexType BufferF32x4_0p1::mBuiltFlagMutex;

BufferF32x4_0p1::BufferF32x4_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BufferF32x4_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BufferF32x4_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BufferF32x4_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BufferF32x4_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BufferF32x4_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
