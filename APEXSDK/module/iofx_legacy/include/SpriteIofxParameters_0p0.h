...
static const physx::PxU32 checksum[] = { 0xed7d359d, 0xba5eb1e1, 0x9ac6c5dd, 0xb1f7ef05, };

} // namespace SpriteIofxParameters_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class SpriteIofxParameters_0p0 : public NxParameterized::NxParameters, public SpriteIofxParameters_0p0NS::ParametersStruct
{
public:
	SpriteIofxParameters_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class SpriteIofxParameters_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, SpriteIofxParameters_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(SpriteIofxParameters_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, SpriteIofxParameters_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, SpriteIofxParameters_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, SpriteIofxParameters_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p0");
			return 0;
		}
