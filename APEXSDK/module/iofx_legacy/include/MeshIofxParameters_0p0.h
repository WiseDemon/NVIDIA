...
static const physx::PxU32 checksum[] = { 0xa0c3f29f, 0x5dfadb24, 0xca44ca2c, 0x76243c01, };

} // namespace MeshIofxParameters_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class MeshIofxParameters_0p0 : public NxParameterized::NxParameters, public MeshIofxParameters_0p0NS::ParametersStruct
{
public:
	MeshIofxParameters_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class MeshIofxParameters_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, MeshIofxParameters_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class MeshIofxParameters_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(MeshIofxParameters_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, MeshIofxParameters_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, MeshIofxParameters_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, MeshIofxParameters_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class MeshIofxParameters_0p0");
			return 0;
		}
