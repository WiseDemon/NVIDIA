...
static const physx::PxU32 checksum[] = { 0xafdd3ba3, 0x21232d96, 0xc0d0f73b, 0x0b558710, };

} // namespace SpriteIofxParameters_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class SpriteIofxParameters_0p1 : public NxParameterized::NxParameters, public SpriteIofxParameters_0p1NS::ParametersStruct
{
public:
	SpriteIofxParameters_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class SpriteIofxParameters_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, SpriteIofxParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(SpriteIofxParameters_0p1)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, SpriteIofxParameters_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, SpriteIofxParameters_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, SpriteIofxParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p1");
			return 0;
		}
