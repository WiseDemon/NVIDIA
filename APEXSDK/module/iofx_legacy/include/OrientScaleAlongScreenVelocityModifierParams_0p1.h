...
struct ParametersStruct
{
	...
	physx::PxF32 scaleChangeLimit;
	physx::PxF32 scaleChangeDelay;

};

static const physx::PxU32 checksum[] = { 0x2a151b3c, 0x4a3faff3, 0xb9e6ebc2, 0x6ec77c7c, };

} // namespace OrientScaleAlongScreenVelocityModifierParams_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class OrientScaleAlongScreenVelocityModifierParams_0p1 : public NxParameterized::NxParameters, public OrientScaleAlongScreenVelocityModifierParams_0p1NS::ParametersStruct
{
public:
	OrientScaleAlongScreenVelocityModifierParams_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class OrientScaleAlongScreenVelocityModifierParams_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, OrientScaleAlongScreenVelocityModifierParams_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientScaleAlongScreenVelocityModifierParams_0p1");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, OrientScaleAlongScreenVelocityModifierParams_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, OrientScaleAlongScreenVelocityModifierParams_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, OrientScaleAlongScreenVelocityModifierParams_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientScaleAlongScreenVelocityModifierParams_0p1");
			return 0;
		}
