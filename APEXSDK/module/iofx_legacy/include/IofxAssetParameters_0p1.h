...
static const physx::PxU32 checksum[] = { 0x4f59ea8d, 0xffdb948a, 0x87165d25, 0xda1345f1, };

} // namespace IofxAssetParameters_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class IofxAssetParameters_0p1 : public NxParameterized::NxParameters, public IofxAssetParameters_0p1NS::ParametersStruct
{
public:
	IofxAssetParameters_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class IofxAssetParameters_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, IofxAssetParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class IofxAssetParameters_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(IofxAssetParameters_0p1)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, IofxAssetParameters_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, IofxAssetParameters_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, IofxAssetParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class IofxAssetParameters_0p1");
			return 0;
		}
