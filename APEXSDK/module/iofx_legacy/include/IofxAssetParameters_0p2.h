...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class IofxAssetParameters_0p2 : public NxParameterized::NxParameters, public IofxAssetParameters_0p2NS::ParametersStruct
{
public:
	IofxAssetParameters_0p2(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class IofxAssetParameters_0p2Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, IofxAssetParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class IofxAssetParameters_0p2");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(IofxAssetParameters_0p2)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, IofxAssetParameters_0p2)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, IofxAssetParameters_0p2::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, IofxAssetParameters_0p2::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class IofxAssetParameters_0p2");
			return 0;
		}
