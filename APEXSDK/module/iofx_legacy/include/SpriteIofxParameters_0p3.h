...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class SpriteIofxParameters_0p3 : public NxParameterized::NxParameters, public SpriteIofxParameters_0p3NS::ParametersStruct
{
public:
	SpriteIofxParameters_0p3(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class SpriteIofxParameters_0p3Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, SpriteIofxParameters_0p3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p3");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(SpriteIofxParameters_0p3)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, SpriteIofxParameters_0p3)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, SpriteIofxParameters_0p3::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, SpriteIofxParameters_0p3::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p3");
			return 0;
		}
