...
static const physx::PxU32 checksum[] = { 0x962242b0, 0x08c5a118, 0x531f8120, 0xb59848e7, };

} // namespace RotationModifierParams_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class RotationModifierParams_0p0 : public NxParameterized::NxParameters, public RotationModifierParams_0p0NS::ParametersStruct
{
public:
	RotationModifierParams_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class RotationModifierParams_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, RotationModifierParams_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RotationModifierParams_0p0");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(RotationModifierParams_0p0)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, RotationModifierParams_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, RotationModifierParams_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, RotationModifierParams_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RotationModifierParams_0p0");
			return 0;
		}
