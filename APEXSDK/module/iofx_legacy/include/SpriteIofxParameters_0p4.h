...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class SpriteIofxParameters_0p4 : public NxParameterized::NxParameters, public SpriteIofxParameters_0p4NS::ParametersStruct
{
public:
	SpriteIofxParameters_0p4(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class SpriteIofxParameters_0p4Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, SpriteIofxParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p4");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(SpriteIofxParameters_0p4)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, SpriteIofxParameters_0p4)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, SpriteIofxParameters_0p4::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, SpriteIofxParameters_0p4::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SpriteIofxParameters_0p4");
			return 0;
		}
