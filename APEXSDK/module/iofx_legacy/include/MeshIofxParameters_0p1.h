...
static const physx::PxU32 checksum[] = { 0x68878fe3, 0xe53d77a0, 0x5178ce8f, 0x88a54038, };

} // namespace MeshIofxParameters_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class MeshIofxParameters_0p1 : public NxParameterized::NxParameters, public MeshIofxParameters_0p1NS::ParametersStruct
{
public:
	MeshIofxParameters_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class MeshIofxParameters_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, MeshIofxParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class MeshIofxParameters_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(MeshIofxParameters_0p1)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, MeshIofxParameters_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, MeshIofxParameters_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, MeshIofxParameters_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class MeshIofxParameters_0p1");
			return 0;
		}
