...
static const physx::PxU32 checksum[] = { 0xf08408dd, 0x7267c270, 0x443cb618, 0x54d60d9e, };

} // namespace OrientScaleAlongScreenVelocityModifierParams_0p0NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class OrientScaleAlongScreenVelocityModifierParams_0p0 : public NxParameterized::NxParameters, public OrientScaleAlongScreenVelocityModifierParams_0p0NS::ParametersStruct
{
public:
	OrientScaleAlongScreenVelocityModifierParams_0p0(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class OrientScaleAlongScreenVelocityModifierParams_0p0Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, OrientScaleAlongScreenVelocityModifierParams_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientScaleAlongScreenVelocityModifierParams_0p0");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, OrientScaleAlongScreenVelocityModifierParams_0p0)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, OrientScaleAlongScreenVelocityModifierParams_0p0::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, OrientScaleAlongScreenVelocityModifierParams_0p0::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientScaleAlongScreenVelocityModifierParams_0p0");
			return 0;
		}
