...
static const physx::PxU32 checksum[] = { 0xcf3b33a5, 0x090197ba, 0xe9b4a8b5, 0xc5d33f94, };

} // namespace RotationModifierParams_0p1NS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class RotationModifierParams_0p1 : public NxParameterized::NxParameters, public RotationModifierParams_0p1NS::ParametersStruct
{
public:
	RotationModifierParams_0p1(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class RotationModifierParams_0p1Factory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, RotationModifierParams_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RotationModifierParams_0p1");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(RotationModifierParams_0p1)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, RotationModifierParams_0p1)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, RotationModifierParams_0p1::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, RotationModifierParams_0p1::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RotationModifierParams_0p1");
			return 0;
		}
