...
const char* const SpriteIofxParameters_0p2Factory::vptr =
    NxParameterized::getVptr<SpriteIofxParameters_0p2, SpriteIofxParameters_0p2::ClassAlignment>();
...
NxParameterized::MutexType SpriteIofxParameters_0p2::mBuiltFlagMutex;

SpriteIofxParameters_0p2::SpriteIofxParameters_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SpriteIofxParameters_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SpriteIofxParameters_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SpriteIofxParameters_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
