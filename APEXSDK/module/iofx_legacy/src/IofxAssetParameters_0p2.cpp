...
const char* const IofxAssetParameters_0p2Factory::vptr =
    NxParameterized::getVptr<IofxAssetParameters_0p2, IofxAssetParameters_0p2::ClassAlignment>();
...
NxParameterized::MutexType IofxAssetParameters_0p2::mBuiltFlagMutex;

IofxAssetParameters_0p2::IofxAssetParameters_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* IofxAssetParameters_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* IofxAssetParameters_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType IofxAssetParameters_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType IofxAssetParameters_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void IofxAssetParameters_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
