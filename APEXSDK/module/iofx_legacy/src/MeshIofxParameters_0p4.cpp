...
const char* const MeshIofxParameters_0p4Factory::vptr =
    NxParameterized::getVptr<MeshIofxParameters_0p4, MeshIofxParameters_0p4::ClassAlignment>();
...
NxParameterized::MutexType MeshIofxParameters_0p4::mBuiltFlagMutex;

MeshIofxParameters_0p4::MeshIofxParameters_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* MeshIofxParameters_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* MeshIofxParameters_0p4::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType MeshIofxParameters_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType MeshIofxParameters_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void MeshIofxParameters_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
