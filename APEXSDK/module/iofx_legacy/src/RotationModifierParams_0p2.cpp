...
const char* const RotationModifierParams_0p2Factory::vptr =
    NxParameterized::getVptr<RotationModifierParams_0p2, RotationModifierParams_0p2::ClassAlignment>();
...
NxParameterized::MutexType RotationModifierParams_0p2::mBuiltFlagMutex;

RotationModifierParams_0p2::RotationModifierParams_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RotationModifierParams_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RotationModifierParams_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RotationModifierParams_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RotationModifierParams_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RotationModifierParams_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
