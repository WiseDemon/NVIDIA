...
const char* const IofxAssetParameters_0p0Factory::vptr =
    NxParameterized::getVptr<IofxAssetParameters_0p0, IofxAssetParameters_0p0::ClassAlignment>();
...
NxParameterized::MutexType IofxAssetParameters_0p0::mBuiltFlagMutex;

IofxAssetParameters_0p0::IofxAssetParameters_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* IofxAssetParameters_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* IofxAssetParameters_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType IofxAssetParameters_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType IofxAssetParameters_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void IofxAssetParameters_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
