...
const char* const MeshIofxParameters_0p3Factory::vptr =
    NxParameterized::getVptr<MeshIofxParameters_0p3, MeshIofxParameters_0p3::ClassAlignment>();
...
NxParameterized::MutexType MeshIofxParameters_0p3::mBuiltFlagMutex;

MeshIofxParameters_0p3::MeshIofxParameters_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* MeshIofxParameters_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* MeshIofxParameters_0p3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType MeshIofxParameters_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType MeshIofxParameters_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void MeshIofxParameters_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void MeshIofxParameters_0p3::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=7, longName="continuousModifierList"
	{
		...
		HintTable[3].init("INCLUDED", physx::PxU64(1), true);
		...
		ParamDefTable[7].setHints((const NxParameterized::Hint**)HintPtrTable, 6);
	...
	// Initialize DefinitionImpl node: nodeIndex=8, longName="continuousModifierList[]"
	{
		...
		HintTable[4].init("longDescription", "These modifiers are applied to the instanced objects every frame.", true);
		HintTable[5].init("shortDescription", "Continuous modifier list", true);
		ParamDefTable[8].setHints((const NxParameterized::Hint**)HintPtrTable, 6);
