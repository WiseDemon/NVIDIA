...
const char* const SpriteIofxParameters_0p0Factory::vptr =
    NxParameterized::getVptr<SpriteIofxParameters_0p0, SpriteIofxParameters_0p0::ClassAlignment>();
...
NxParameterized::MutexType SpriteIofxParameters_0p0::mBuiltFlagMutex;

SpriteIofxParameters_0p0::SpriteIofxParameters_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SpriteIofxParameters_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SpriteIofxParameters_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SpriteIofxParameters_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void SpriteIofxParameters_0p0::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=4, longName="continuousModifierList"
	{
		...
		HintTable[6].init("INCLUDED", physx::PxU64(1), true);
	...
	// Initialize DefinitionImpl node: nodeIndex=5, longName="continuousModifierList[]"
	{
		...
		HintTable[5].init("HIDE_CLASS6", "RotationModifierParams", true);
		HintTable[6].init("INCLUDED", physx::PxU64(1), true);
		ParamDefTable[5].setHints((const NxParameterized::Hint**)HintPtrTable, 7);
		...
		HintTable[7].init("longDescription", "These modifiers are applied to the instanced objects every frame. (Currently RotationModifierParams is unsupported for sprites)", true);
		HintTable[8].init("shortDescription", "Continuous modifier list", true);
		ParamDefTable[5].setHints((const NxParameterized::Hint**)HintPtrTable, 9);
