...
const char* const MeshIofxParameters_0p2Factory::vptr =
    NxParameterized::getVptr<MeshIofxParameters_0p2, MeshIofxParameters_0p2::ClassAlignment>();
...
NxParameterized::MutexType MeshIofxParameters_0p2::mBuiltFlagMutex;

MeshIofxParameters_0p2::MeshIofxParameters_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* MeshIofxParameters_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* MeshIofxParameters_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType MeshIofxParameters_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType MeshIofxParameters_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void MeshIofxParameters_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
