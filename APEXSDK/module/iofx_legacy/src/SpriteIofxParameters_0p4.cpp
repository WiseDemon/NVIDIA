...
const char* const SpriteIofxParameters_0p4Factory::vptr =
    NxParameterized::getVptr<SpriteIofxParameters_0p4, SpriteIofxParameters_0p4::ClassAlignment>();
...
NxParameterized::MutexType SpriteIofxParameters_0p4::mBuiltFlagMutex;

SpriteIofxParameters_0p4::SpriteIofxParameters_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters_0p4::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SpriteIofxParameters_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SpriteIofxParameters_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SpriteIofxParameters_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void SpriteIofxParameters_0p4::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=4, longName="continuousModifierList"
	{
		...
		HintTable[7].init("INCLUDED", physx::PxU64(1), true);
		...
		ParamDefTable[4].setHints((const NxParameterized::Hint**)HintPtrTable, 10);
	...
	// Initialize DefinitionImpl node: nodeIndex=5, longName="continuousModifierList[]"
	{
		...
		HintTable[8].init("longDescription", "These modifiers are applied to the instanced objects every frame. (Currently RotationModifierParams is unsupported for sprites)", true);
		HintTable[9].init("shortDescription", "Continuous modifier list", true);
		ParamDefTable[5].setHints((const NxParameterized::Hint**)HintPtrTable, 10);
