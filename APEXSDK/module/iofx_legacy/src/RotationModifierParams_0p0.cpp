...
const char* const RotationModifierParams_0p0Factory::vptr =
    NxParameterized::getVptr<RotationModifierParams_0p0, RotationModifierParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType RotationModifierParams_0p0::mBuiltFlagMutex;

RotationModifierParams_0p0::RotationModifierParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RotationModifierParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RotationModifierParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RotationModifierParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RotationModifierParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RotationModifierParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
