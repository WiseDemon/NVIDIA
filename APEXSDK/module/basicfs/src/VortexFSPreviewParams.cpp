...
const char* const VortexFSPreviewParamsFactory::vptr =
    NxParameterized::getVptr<VortexFSPreviewParams, VortexFSPreviewParams::ClassAlignment>();
...
NxParameterized::MutexType VortexFSPreviewParams::mBuiltFlagMutex;

VortexFSPreviewParams::VortexFSPreviewParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* VortexFSPreviewParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* VortexFSPreviewParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType VortexFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType VortexFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VortexFSPreviewParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
