...
const char* const AttractorFSPreviewParamsFactory::vptr =
    NxParameterized::getVptr<AttractorFSPreviewParams, AttractorFSPreviewParams::ClassAlignment>();
...
NxParameterized::MutexType AttractorFSPreviewParams::mBuiltFlagMutex;

AttractorFSPreviewParams::AttractorFSPreviewParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* AttractorFSPreviewParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* AttractorFSPreviewParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType AttractorFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType AttractorFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFSPreviewParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
