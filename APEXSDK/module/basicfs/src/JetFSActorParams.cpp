...
const char* const JetFSActorParamsFactory::vptr =
    NxParameterized::getVptr<JetFSActorParams, JetFSActorParams::ClassAlignment>();
...
NxParameterized::MutexType JetFSActorParams::mBuiltFlagMutex;

JetFSActorParams::JetFSActorParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* JetFSActorParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* JetFSActorParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType JetFSActorParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType JetFSActorParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFSActorParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
