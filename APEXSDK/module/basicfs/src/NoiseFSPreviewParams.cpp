...
const char* const NoiseFSPreviewParamsFactory::vptr =
    NxParameterized::getVptr<NoiseFSPreviewParams, NoiseFSPreviewParams::ClassAlignment>();
...
NxParameterized::MutexType NoiseFSPreviewParams::mBuiltFlagMutex;

NoiseFSPreviewParams::NoiseFSPreviewParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* NoiseFSPreviewParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* NoiseFSPreviewParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType NoiseFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType NoiseFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFSPreviewParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
