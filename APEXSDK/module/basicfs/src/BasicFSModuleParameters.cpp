...
const char* const BasicFSModuleParametersFactory::vptr =
    NxParameterized::getVptr<BasicFSModuleParameters, BasicFSModuleParameters::ClassAlignment>();
...
NxParameterized::MutexType BasicFSModuleParameters::mBuiltFlagMutex;

BasicFSModuleParameters::BasicFSModuleParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BasicFSModuleParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicFSModuleParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BasicFSModuleParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicFSModuleParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicFSModuleParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
