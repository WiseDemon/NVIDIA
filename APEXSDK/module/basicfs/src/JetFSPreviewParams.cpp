...
const char* const JetFSPreviewParamsFactory::vptr =
    NxParameterized::getVptr<JetFSPreviewParams, JetFSPreviewParams::ClassAlignment>();
...
NxParameterized::MutexType JetFSPreviewParams::mBuiltFlagMutex;

JetFSPreviewParams::JetFSPreviewParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* JetFSPreviewParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* JetFSPreviewParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType JetFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType JetFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFSPreviewParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
