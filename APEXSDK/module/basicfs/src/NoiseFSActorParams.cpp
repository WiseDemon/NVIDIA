...
const char* const NoiseFSActorParamsFactory::vptr =
    NxParameterized::getVptr<NoiseFSActorParams, NoiseFSActorParams::ClassAlignment>();
...
NxParameterized::MutexType NoiseFSActorParams::mBuiltFlagMutex;

NoiseFSActorParams::NoiseFSActorParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* NoiseFSActorParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* NoiseFSActorParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType NoiseFSActorParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType NoiseFSActorParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFSActorParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
