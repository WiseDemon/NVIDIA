...
const char* const AttractorFSActorParamsFactory::vptr =
    NxParameterized::getVptr<AttractorFSActorParams, AttractorFSActorParams::ClassAlignment>();
...
NxParameterized::MutexType AttractorFSActorParams::mBuiltFlagMutex;

AttractorFSActorParams::AttractorFSActorParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* AttractorFSActorParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* AttractorFSActorParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType AttractorFSActorParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType AttractorFSActorParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFSActorParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
