...
const char* const WindFSPreviewParamsFactory::vptr =
    NxParameterized::getVptr<WindFSPreviewParams, WindFSPreviewParams::ClassAlignment>();
...
NxParameterized::MutexType WindFSPreviewParams::mBuiltFlagMutex;

WindFSPreviewParams::WindFSPreviewParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* WindFSPreviewParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* WindFSPreviewParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType WindFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType WindFSPreviewParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void WindFSPreviewParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
