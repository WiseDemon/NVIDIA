...
static const physx::PxU32 checksum[] = { 0x11d039e3, 0x0cef82d9, 0xc9f32768, 0x11cc1d89, };

} // namespace WindFSActorParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class WindFSActorParams : public NxParameterized::NxParameters, public WindFSActorParamsNS::ParametersStruct
{
public:
	WindFSActorParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class WindFSActorParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, WindFSActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class WindFSActorParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(WindFSActorParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, WindFSActorParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, WindFSActorParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, WindFSActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class WindFSActorParams");
			return 0;
		}
