...
static const physx::PxU32 checksum[] = { 0x8922c590, 0x18102a05, 0xf09b9b50, 0xdcef001a, };

} // namespace AttractorFSPreviewParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class AttractorFSPreviewParams : public NxParameterized::NxParameters, public AttractorFSPreviewParamsNS::ParametersStruct
{
public:
	AttractorFSPreviewParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class AttractorFSPreviewParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, AttractorFSPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class AttractorFSPreviewParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(AttractorFSPreviewParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, AttractorFSPreviewParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, AttractorFSPreviewParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, AttractorFSPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class AttractorFSPreviewParams");
			return 0;
		}
