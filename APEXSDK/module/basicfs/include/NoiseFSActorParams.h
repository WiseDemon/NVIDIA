...
static const physx::PxU32 checksum[] = { 0x64912988, 0x84d63a13, 0x1f7cba86, 0xafacea1e, };

} // namespace NoiseFSActorParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class NoiseFSActorParams : public NxParameterized::NxParameters, public NoiseFSActorParamsNS::ParametersStruct
{
public:
	NoiseFSActorParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class NoiseFSActorParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, NoiseFSActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class NoiseFSActorParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(NoiseFSActorParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, NoiseFSActorParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, NoiseFSActorParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, NoiseFSActorParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class NoiseFSActorParams");
			return 0;
		}
