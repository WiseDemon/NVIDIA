...
static const physx::PxU32 checksum[] = { 0xb4818bbc, 0x84a817f6, 0x02ddad4a, 0x91a3c5ec, };

} // namespace WindFSPreviewParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class WindFSPreviewParams : public NxParameterized::NxParameters, public WindFSPreviewParamsNS::ParametersStruct
{
public:
	WindFSPreviewParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class WindFSPreviewParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, WindFSPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class WindFSPreviewParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(WindFSPreviewParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, WindFSPreviewParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, WindFSPreviewParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, WindFSPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class WindFSPreviewParams");
			return 0;
		}
