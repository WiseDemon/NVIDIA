...
#define INPLACE_TYPE_STRUCT_FIELDS \
	INPLACE_TYPE_FIELD(physx::PxVec3, fieldValue)
#include INPLACE_TYPE_BUILD()


PX_CUDA_CALLABLE PX_INLINE physx::PxVec3 evalWind(const WindFSParams& params)
{
	return params.fieldValue;
}

PX_CUDA_CALLABLE PX_INLINE physx::PxVec3 executeWindFS(const WindFSParams& params, const physx::PxVec3& )
{
