...
static const physx::PxU32 checksum[] = { 0xbc265cbc, 0xf8125270, 0x2746f91e, 0xf4e63077, };

} // namespace VortexFSPreviewParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class VortexFSPreviewParams : public NxParameterized::NxParameters, public VortexFSPreviewParamsNS::ParametersStruct
{
public:
	VortexFSPreviewParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class VortexFSPreviewParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, VortexFSPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VortexFSPreviewParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(VortexFSPreviewParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, VortexFSPreviewParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, VortexFSPreviewParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, VortexFSPreviewParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class VortexFSPreviewParams");
			return 0;
		}
