...
using namespace ParticleIosAssetParam_0p2NS;

const char* const ParticleIosAssetParam_0p2Factory::vptr =
    NxParameterized::getVptr<ParticleIosAssetParam_0p2, ParticleIosAssetParam_0p2::ClassAlignment>();
...
bool ParticleIosAssetParam_0p2::mBuiltFlag = false;
NxParameterized::MutexType ParticleIosAssetParam_0p2::mBuiltFlagMutex;

ParticleIosAssetParam_0p2::ParticleIosAssetParam_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ParticleIosAssetParam_0p2FactoryInst);
...
ParticleIosAssetParam_0p2::~ParticleIosAssetParam_0p2()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ParticleIosAssetParam_0p2::destroy()
{
	...
	this->~ParticleIosAssetParam_0p2();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ParticleIosAssetParam_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticleIosAssetParam_0p2::getParameterDefinitionTree(void) const
{
	ParticleIosAssetParam_0p2* tmpParam = const_cast<ParticleIosAssetParam_0p2*>(this);
...
NxParameterized::ErrorType ParticleIosAssetParam_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticleIosAssetParam_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosAssetParam_0p2::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ParticleIosAssetParam_0p2::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ParticleIosAssetParam_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ParticleIosAssetParam_0p2::buildTree(void)
{
...
void ParticleIosAssetParam_0p2::initStrings(void)
{
...
void ParticleIosAssetParam_0p2::initDynamicArrays(void)
{
}

void ParticleIosAssetParam_0p2::initDefaults(void)
{
...
void ParticleIosAssetParam_0p2::initReferences(void)
{
	particleType = NULL;

}

void ParticleIosAssetParam_0p2::freeDynamicArrays(void)
{
}

void ParticleIosAssetParam_0p2::freeStrings(void)
{
...
void ParticleIosAssetParam_0p2::freeReferences(void)
{
	if (particleType)
	{
