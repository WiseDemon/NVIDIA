...
using namespace ParticleIosAssetParam_0p4NS;

const char* const ParticleIosAssetParam_0p4Factory::vptr =
    NxParameterized::getVptr<ParticleIosAssetParam_0p4, ParticleIosAssetParam_0p4::ClassAlignment>();
...
bool ParticleIosAssetParam_0p4::mBuiltFlag = false;
NxParameterized::MutexType ParticleIosAssetParam_0p4::mBuiltFlagMutex;

ParticleIosAssetParam_0p4::ParticleIosAssetParam_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ParticleIosAssetParam_0p4FactoryInst);
...
ParticleIosAssetParam_0p4::~ParticleIosAssetParam_0p4()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ParticleIosAssetParam_0p4::destroy()
{
	...
	this->~ParticleIosAssetParam_0p4();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ParticleIosAssetParam_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticleIosAssetParam_0p4::getParameterDefinitionTree(void) const
{
	ParticleIosAssetParam_0p4* tmpParam = const_cast<ParticleIosAssetParam_0p4*>(this);
...
NxParameterized::ErrorType ParticleIosAssetParam_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticleIosAssetParam_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosAssetParam_0p4::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ParticleIosAssetParam_0p4::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ParticleIosAssetParam_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ParticleIosAssetParam_0p4::buildTree(void)
{
...
void ParticleIosAssetParam_0p4::initStrings(void)
{
...
void ParticleIosAssetParam_0p4::initDynamicArrays(void)
{
}

void ParticleIosAssetParam_0p4::initDefaults(void)
{
...
void ParticleIosAssetParam_0p4::initReferences(void)
{
	particleType = NULL;

}

void ParticleIosAssetParam_0p4::freeDynamicArrays(void)
{
}

void ParticleIosAssetParam_0p4::freeStrings(void)
{
...
void ParticleIosAssetParam_0p4::freeReferences(void)
{
	if (particleType)
	{
