...
using namespace ParticleIosAssetParam_0p3NS;

const char* const ParticleIosAssetParam_0p3Factory::vptr =
    NxParameterized::getVptr<ParticleIosAssetParam_0p3, ParticleIosAssetParam_0p3::ClassAlignment>();
...
{
	{ TYPE_STRUCT, false, 0, CHILDREN(0), 26 },
...
bool ParticleIosAssetParam_0p3::mBuiltFlag = false;
NxParameterized::MutexType ParticleIosAssetParam_0p3::mBuiltFlagMutex;

ParticleIosAssetParam_0p3::ParticleIosAssetParam_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ParticleIosAssetParam_0p3FactoryInst);
...
ParticleIosAssetParam_0p3::~ParticleIosAssetParam_0p3()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ParticleIosAssetParam_0p3::destroy()
{
	...
	this->~ParticleIosAssetParam_0p3();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ParticleIosAssetParam_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ParticleIosAssetParam_0p3::getParameterDefinitionTree(void) const
{
	ParticleIosAssetParam_0p3* tmpParam = const_cast<ParticleIosAssetParam_0p3*>(this);
...
NxParameterized::ErrorType ParticleIosAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ParticleIosAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ParticleIosAssetParam_0p3::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ParticleIosAssetParam_0p3::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ParticleIosAssetParam_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ParticleIosAssetParam_0p3::buildTree(void)
{
	...
	// SetChildren for: nodeIndex=0, longName=""
	{
		...
		ParamDefTable[0].setChildren(Children, 26);
	}

	mBuiltFlag = true;

}
void ParticleIosAssetParam_0p3::initStrings(void)
{
...
void ParticleIosAssetParam_0p3::initDynamicArrays(void)
{
}

void ParticleIosAssetParam_0p3::initDefaults(void)
{
...
void ParticleIosAssetParam_0p3::initReferences(void)
{
	particleType = NULL;

}

void ParticleIosAssetParam_0p3::freeDynamicArrays(void)
{
}

void ParticleIosAssetParam_0p3::freeStrings(void)
{
...
void ParticleIosAssetParam_0p3::freeReferences(void)
{
	if (particleType)
	{
