...
using namespace JetFSAssetParams_0p1NS;

const char* const JetFSAssetParams_0p1Factory::vptr =
    NxParameterized::getVptr<JetFSAssetParams_0p1, JetFSAssetParams_0p1::ClassAlignment>();
...
bool JetFSAssetParams_0p1::mBuiltFlag = false;
NxParameterized::MutexType JetFSAssetParams_0p1::mBuiltFlagMutex;

JetFSAssetParams_0p1::JetFSAssetParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &JetFSAssetParams_0p1FactoryInst);
...
void JetFSAssetParams_0p1::destroy()
{
	...
	this->~JetFSAssetParams_0p1();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* JetFSAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* JetFSAssetParams_0p1::getParameterDefinitionTree(void) const
{
	JetFSAssetParams_0p1* tmpParam = const_cast<JetFSAssetParams_0p1*>(this);
...
NxParameterized::ErrorType JetFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType JetFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFSAssetParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<JetFSAssetParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void JetFSAssetParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void JetFSAssetParams_0p1::buildTree(void)
{
...
void JetFSAssetParams_0p1::initStrings(void)
{
...
void JetFSAssetParams_0p1::initDynamicArrays(void)
{
}

void JetFSAssetParams_0p1::initDefaults(void)
{
...
void JetFSAssetParams_0p1::initReferences(void)
{
}

void JetFSAssetParams_0p1::freeDynamicArrays(void)
{
}

void JetFSAssetParams_0p1::freeStrings(void)
{
...
void JetFSAssetParams_0p1::freeReferences(void)
{
}
