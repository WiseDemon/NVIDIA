...
const char* const WindFSAssetParams_0p1Factory::vptr =
    NxParameterized::getVptr<WindFSAssetParams_0p1, WindFSAssetParams_0p1::ClassAlignment>();
...
NxParameterized::MutexType WindFSAssetParams_0p1::mBuiltFlagMutex;

WindFSAssetParams_0p1::WindFSAssetParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* WindFSAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* WindFSAssetParams_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType WindFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType WindFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void WindFSAssetParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
