...
using namespace NoiseFSAssetParams_0p1NS;

const char* const NoiseFSAssetParams_0p1Factory::vptr =
    NxParameterized::getVptr<NoiseFSAssetParams_0p1, NoiseFSAssetParams_0p1::ClassAlignment>();
...
bool NoiseFSAssetParams_0p1::mBuiltFlag = false;
NxParameterized::MutexType NoiseFSAssetParams_0p1::mBuiltFlagMutex;

NoiseFSAssetParams_0p1::NoiseFSAssetParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &NoiseFSAssetParams_0p1FactoryInst);
...
NoiseFSAssetParams_0p1::~NoiseFSAssetParams_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void NoiseFSAssetParams_0p1::destroy()
{
	...
	this->~NoiseFSAssetParams_0p1();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* NoiseFSAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* NoiseFSAssetParams_0p1::getParameterDefinitionTree(void) const
{
	NoiseFSAssetParams_0p1* tmpParam = const_cast<NoiseFSAssetParams_0p1*>(this);
...
NxParameterized::ErrorType NoiseFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType NoiseFSAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFSAssetParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<NoiseFSAssetParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void NoiseFSAssetParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void NoiseFSAssetParams_0p1::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=17, longName="useLocalSpace"
	{
...
void NoiseFSAssetParams_0p1::initStrings(void)
{
...
void NoiseFSAssetParams_0p1::initDynamicArrays(void)
{
}

void NoiseFSAssetParams_0p1::initDefaults(void)
{
...
void NoiseFSAssetParams_0p1::initReferences(void)
{
}

void NoiseFSAssetParams_0p1::freeDynamicArrays(void)
{
}

void NoiseFSAssetParams_0p1::freeStrings(void)
{
...
void NoiseFSAssetParams_0p1::freeReferences(void)
{
}
