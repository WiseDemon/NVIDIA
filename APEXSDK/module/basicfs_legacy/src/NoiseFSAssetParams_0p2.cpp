...
const char* const NoiseFSAssetParams_0p2Factory::vptr =
    NxParameterized::getVptr<NoiseFSAssetParams_0p2, NoiseFSAssetParams_0p2::ClassAlignment>();
...
NxParameterized::MutexType NoiseFSAssetParams_0p2::mBuiltFlagMutex;

NoiseFSAssetParams_0p2::NoiseFSAssetParams_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* NoiseFSAssetParams_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* NoiseFSAssetParams_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType NoiseFSAssetParams_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType NoiseFSAssetParams_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void NoiseFSAssetParams_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
