...
using namespace AttractorFSAssetParams_0p0NS;

const char* const AttractorFSAssetParams_0p0Factory::vptr =
    NxParameterized::getVptr<AttractorFSAssetParams_0p0, AttractorFSAssetParams_0p0::ClassAlignment>();
...
bool AttractorFSAssetParams_0p0::mBuiltFlag = false;
NxParameterized::MutexType AttractorFSAssetParams_0p0::mBuiltFlagMutex;

AttractorFSAssetParams_0p0::AttractorFSAssetParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &AttractorFSAssetParams_0p0FactoryInst);
...
AttractorFSAssetParams_0p0::~AttractorFSAssetParams_0p0()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void AttractorFSAssetParams_0p0::destroy()
{
	...
	this->~AttractorFSAssetParams_0p0();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* AttractorFSAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* AttractorFSAssetParams_0p0::getParameterDefinitionTree(void) const
{
	AttractorFSAssetParams_0p0* tmpParam = const_cast<AttractorFSAssetParams_0p0*>(this);
...
NxParameterized::ErrorType AttractorFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType AttractorFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void AttractorFSAssetParams_0p0::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<AttractorFSAssetParams_0p0::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void AttractorFSAssetParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void AttractorFSAssetParams_0p0::buildTree(void)
{
...
void AttractorFSAssetParams_0p0::initStrings(void)
{
...
void AttractorFSAssetParams_0p0::initDynamicArrays(void)
{
}

void AttractorFSAssetParams_0p0::initDefaults(void)
{
...
void AttractorFSAssetParams_0p0::initReferences(void)
{
}

void AttractorFSAssetParams_0p0::freeDynamicArrays(void)
{
}

void AttractorFSAssetParams_0p0::freeStrings(void)
{
...
void AttractorFSAssetParams_0p0::freeReferences(void)
{
}
