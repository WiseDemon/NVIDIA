...
const char* const JetFSAssetParams_0p0Factory::vptr =
    NxParameterized::getVptr<JetFSAssetParams_0p0, JetFSAssetParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType JetFSAssetParams_0p0::mBuiltFlagMutex;

JetFSAssetParams_0p0::JetFSAssetParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* JetFSAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* JetFSAssetParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType JetFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType JetFSAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void JetFSAssetParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
