...
using namespace ShapeBoxParams_0p1NS;

const char* const ShapeBoxParams_0p1Factory::vptr =
    NxParameterized::getVptr<ShapeBoxParams_0p1, ShapeBoxParams_0p1::ClassAlignment>();
...
bool ShapeBoxParams_0p1::mBuiltFlag = false;
NxParameterized::MutexType ShapeBoxParams_0p1::mBuiltFlagMutex;

ShapeBoxParams_0p1::ShapeBoxParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &ShapeBoxParams_0p1FactoryInst);
...
ShapeBoxParams_0p1::~ShapeBoxParams_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void ShapeBoxParams_0p1::destroy()
{
	...
	this->~ShapeBoxParams_0p1();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* ShapeBoxParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ShapeBoxParams_0p1::getParameterDefinitionTree(void) const
{
	ShapeBoxParams_0p1* tmpParam = const_cast<ShapeBoxParams_0p1*>(this);
...
NxParameterized::ErrorType ShapeBoxParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ShapeBoxParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ShapeBoxParams_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<ShapeBoxParams_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void ShapeBoxParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ShapeBoxParams_0p1::buildTree(void)
{
...
void ShapeBoxParams_0p1::initStrings(void)
{
}

void ShapeBoxParams_0p1::initDynamicArrays(void)
{
}

void ShapeBoxParams_0p1::initDefaults(void)
{
...
void ShapeBoxParams_0p1::initReferences(void)
{
}

void ShapeBoxParams_0p1::freeDynamicArrays(void)
{
}

void ShapeBoxParams_0p1::freeStrings(void)
{
}

void ShapeBoxParams_0p1::freeReferences(void)
{
}
