...
#define INPLACE_TYPE_STRUCT_FIELDS \
	INPLACE_TYPE_FIELD(physx::PxBounds3,	bounds) \
	INPLACE_TYPE_FIELD(physx::PxU32,		priority)
#include INPLACE_TYPE_BUILD()

typedef InplaceArray<VolumeParams> VolumeParamsArray;
typedef InplaceArray<physx::PxU32> ActorClassIDBitmapArray;

typedef InplaceArray<physx::PxU32> ActorIDRemapArray;

//struct ModifierListElem
#define INPLACE_TYPE_STRUCT_NAME ModifierListElem
#define INPLACE_TYPE_STRUCT_FIELDS \
	INPLACE_TYPE_FIELD(physx::PxU32,		type) \
...
#define INPLACE_TYPE_STRUCT_FIELDS \
	INPLACE_TYPE_FIELD(physx::PxF32,				objectScale) \
