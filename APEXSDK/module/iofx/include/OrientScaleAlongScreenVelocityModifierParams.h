...
#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class OrientScaleAlongScreenVelocityModifierParams : public NxParameterized::NxParameters, public OrientScaleAlongScreenVelocityModifierParamsNS::ParametersStruct
{
public:
	OrientScaleAlongScreenVelocityModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class OrientScaleAlongScreenVelocityModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, OrientScaleAlongScreenVelocityModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientScaleAlongScreenVelocityModifierParams");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, OrientScaleAlongScreenVelocityModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, OrientScaleAlongScreenVelocityModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, OrientScaleAlongScreenVelocityModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientScaleAlongScreenVelocityModifierParams");
			return 0;
		}
