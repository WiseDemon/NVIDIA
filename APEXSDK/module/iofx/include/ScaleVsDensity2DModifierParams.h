...
static const physx::PxU32 checksum[] = { 0x67c772d8, 0x2f573535, 0xdd3f3715, 0xea4c896d, };

} // namespace ScaleVsDensity2DModifierParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ScaleVsDensity2DModifierParams : public NxParameterized::NxParameters, public ScaleVsDensity2DModifierParamsNS::ParametersStruct
{
public:
	ScaleVsDensity2DModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ScaleVsDensity2DModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ScaleVsDensity2DModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ScaleVsDensity2DModifierParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(ScaleVsDensity2DModifierParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, ScaleVsDensity2DModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ScaleVsDensity2DModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ScaleVsDensity2DModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ScaleVsDensity2DModifierParams");
			return 0;
		}
