...
static const physx::PxU32 checksum[] = { 0x704cda91, 0xcc96c538, 0x11f054f6, 0xa3fc1c9e, };

} // namespace RotationRateVsLifeModifierParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class RotationRateVsLifeModifierParams : public NxParameterized::NxParameters, public RotationRateVsLifeModifierParamsNS::ParametersStruct
{
public:
	RotationRateVsLifeModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class RotationRateVsLifeModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, RotationRateVsLifeModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RotationRateVsLifeModifierParams");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, RotationRateVsLifeModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, RotationRateVsLifeModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, RotationRateVsLifeModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RotationRateVsLifeModifierParams");
			return 0;
		}
