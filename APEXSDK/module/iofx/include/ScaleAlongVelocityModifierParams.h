...
static const physx::PxU32 checksum[] = { 0x3c361211, 0x221d234b, 0x639bf597, 0xcca2608b, };

} // namespace ScaleAlongVelocityModifierParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ScaleAlongVelocityModifierParams : public NxParameterized::NxParameters, public ScaleAlongVelocityModifierParamsNS::ParametersStruct
{
public:
	ScaleAlongVelocityModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ScaleAlongVelocityModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ScaleAlongVelocityModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ScaleAlongVelocityModifierParams");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ScaleAlongVelocityModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ScaleAlongVelocityModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ScaleAlongVelocityModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ScaleAlongVelocityModifierParams");
			return 0;
		}
