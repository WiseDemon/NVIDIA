...
public:
	                       ...
	                       NxParamDynamicArrayStruct* controlPoints)
	{
		...
		h.resizeArray((physx::PxI32)cpSize);
...
public:
	...
	void mapParams(Mapper& mapper, Params* params) const
	{
		...
		mapper.mapValue(offsetof(Params, includeVerticalDirection), physx::PxU32(mParams->includeVerticalDirection));
...
public:
	...
	virtual physx::PxF32 getScaleChangeLimit() const
	{
		return mParams->scaleChangeLimit;
	}
	virtual void setScaleChangeLimit(const physx::PxF32& s)
	{
		mParams->scaleChangeLimit = s;
	}

	virtual physx::PxF32 getScaleChangeDelay() const
	{
		return mParams->scaleChangeDelay;
	}
	virtual void setScaleChangeDelay(const physx::PxF32& s)
	{
