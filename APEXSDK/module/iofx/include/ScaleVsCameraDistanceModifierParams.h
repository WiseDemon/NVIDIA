...
static const physx::PxU32 checksum[] = { 0x2c4aba3d, 0xa1d08f53, 0xfb08d5f3, 0xe12927dd, };

} // namespace ScaleVsCameraDistanceModifierParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class ScaleVsCameraDistanceModifierParams : public NxParameterized::NxParameters, public ScaleVsCameraDistanceModifierParamsNS::ParametersStruct
{
public:
	ScaleVsCameraDistanceModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class ScaleVsCameraDistanceModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, ScaleVsCameraDistanceModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ScaleVsCameraDistanceModifierParams");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, ScaleVsCameraDistanceModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, ScaleVsCameraDistanceModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, ScaleVsCameraDistanceModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class ScaleVsCameraDistanceModifierParams");
			return 0;
		}
