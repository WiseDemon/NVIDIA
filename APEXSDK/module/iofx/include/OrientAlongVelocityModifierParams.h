...
static const physx::PxU32 checksum[] = { 0xbec07bae, 0xf99a7cd3, 0xa819cd23, 0xe75ba471, };

} // namespace OrientAlongVelocityModifierParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class OrientAlongVelocityModifierParams : public NxParameterized::NxParameters, public OrientAlongVelocityModifierParamsNS::ParametersStruct
{
public:
	OrientAlongVelocityModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class OrientAlongVelocityModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, OrientAlongVelocityModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientAlongVelocityModifierParams");
		...
		return NX_PARAM_PLACEMENT_NEW(newPtr, OrientAlongVelocityModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, OrientAlongVelocityModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, OrientAlongVelocityModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class OrientAlongVelocityModifierParams");
			return 0;
		}
