...
static const physx::PxU32 checksum[] = { 0x7a1ac6ca, 0x76ef1cd2, 0x991bfe05, 0x30c11a09, };

} // namespace SimpleScaleModifierParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class SimpleScaleModifierParams : public NxParameterized::NxParameters, public SimpleScaleModifierParamsNS::ParametersStruct
{
public:
	SimpleScaleModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class SimpleScaleModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, SimpleScaleModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SimpleScaleModifierParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(SimpleScaleModifierParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, SimpleScaleModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, SimpleScaleModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, SimpleScaleModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class SimpleScaleModifierParams");
			return 0;
		}
