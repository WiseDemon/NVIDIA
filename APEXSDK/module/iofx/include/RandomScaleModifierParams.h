...
struct ParametersStruct
{
	...
	physx::PxF32 minScaleFactor;
	physx::PxF32 maxScaleFactor;

};

static const physx::PxU32 checksum[] = { 0x393214a5, 0x3920927a, 0x6b466949, 0x38714cd7, };

} // namespace RandomScaleModifierParamsNS

#ifndef NX_PARAMETERIZED_ONLY_LAYOUTS
class RandomScaleModifierParams : public NxParameterized::NxParameters, public RandomScaleModifierParamsNS::ParametersStruct
{
public:
	RandomScaleModifierParams(NxParameterized::Traits* traits, void* buf = 0, PxI32* refCount = 0);
...
class RandomScaleModifierParamsFactory : public NxParameterized::Factory
{
...
public:
	virtual NxParameterized::Interface* create(NxParameterized::Traits* paramTraits)
	{
		...
		if (!NxParameterized::IsAligned(newPtr, RandomScaleModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RandomScaleModifierParams");
			paramTraits->free(newPtr);
			return 0;
		}

		memset(newPtr, 0, sizeof(RandomScaleModifierParams)); // always initialize memory allocated to zero for default values
		return NX_PARAM_PLACEMENT_NEW(newPtr, RandomScaleModifierParams)(paramTraits);
	}

	virtual NxParameterized::Interface* finish(NxParameterized::Traits* paramTraits, void* bufObj, void* bufStart, physx::PxI32* refCount)
	{
		if (!NxParameterized::IsAligned(bufObj, RandomScaleModifierParams::ClassAlignment)
		        || !NxParameterized::IsAligned(bufStart, RandomScaleModifierParams::ClassAlignment))
		{
			NX_PARAM_TRAITS_WARNING(paramTraits, "Unaligned memory allocation for class RandomScaleModifierParams");
			return 0;
		}
