...
const char* const SpriteIofxParametersFactory::vptr =
    NxParameterized::getVptr<SpriteIofxParameters, SpriteIofxParameters::ClassAlignment>();
...
NxParameterized::MutexType SpriteIofxParameters::mBuiltFlagMutex;

SpriteIofxParameters::SpriteIofxParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* SpriteIofxParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType SpriteIofxParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType SpriteIofxParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void SpriteIofxParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
