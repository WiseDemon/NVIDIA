...
const char* const RandomSubtextureModifierParamsFactory::vptr =
    NxParameterized::getVptr<RandomSubtextureModifierParams, RandomSubtextureModifierParams::ClassAlignment>();
...
NxParameterized::MutexType RandomSubtextureModifierParams::mBuiltFlagMutex;

RandomSubtextureModifierParams::RandomSubtextureModifierParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RandomSubtextureModifierParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RandomSubtextureModifierParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RandomSubtextureModifierParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RandomSubtextureModifierParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RandomSubtextureModifierParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void RandomSubtextureModifierParams::initDefaults(void)
{
	...
	freeReferences();
	freeDynamicArrays();
	minSubtexture = physx::PxF32(0.0f);
	maxSubtexture = physx::PxF32(0.0f);
