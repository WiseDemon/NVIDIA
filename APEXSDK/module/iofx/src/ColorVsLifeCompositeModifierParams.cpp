...
const char* const ColorVsLifeCompositeModifierParamsFactory::vptr =
    NxParameterized::getVptr<ColorVsLifeCompositeModifierParams, ColorVsLifeCompositeModifierParams::ClassAlignment>();
...
NxParameterized::MutexType ColorVsLifeCompositeModifierParams::mBuiltFlagMutex;

ColorVsLifeCompositeModifierParams::ColorVsLifeCompositeModifierParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ColorVsLifeCompositeModifierParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ColorVsLifeCompositeModifierParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ColorVsLifeCompositeModifierParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ColorVsLifeCompositeModifierParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ColorVsLifeCompositeModifierParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ColorVsLifeCompositeModifierParams::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=4, longName="controlPoints[].color"
	{
		...
		ParamDefTable[4].setHints((const NxParameterized::Hint**)HintPtrTable, 9);
