...
const char* const RandomRotationModifierParamsFactory::vptr =
    NxParameterized::getVptr<RandomRotationModifierParams, RandomRotationModifierParams::ClassAlignment>();
...
NxParameterized::MutexType RandomRotationModifierParams::mBuiltFlagMutex;

RandomRotationModifierParams::RandomRotationModifierParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RandomRotationModifierParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RandomRotationModifierParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RandomRotationModifierParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RandomRotationModifierParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RandomRotationModifierParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void RandomRotationModifierParams::initDefaults(void)
{
	...
	freeReferences();
	freeDynamicArrays();
	minRotation = physx::PxF32(0.0f);
	maxRotation = physx::PxF32(0.0f);
