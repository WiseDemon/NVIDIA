...
const char* const RotationModifierParamsFactory::vptr =
    NxParameterized::getVptr<RotationModifierParams, RotationModifierParams::ClassAlignment>();
...
NxParameterized::MutexType RotationModifierParams::mBuiltFlagMutex;

RotationModifierParams::RotationModifierParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RotationModifierParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RotationModifierParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RotationModifierParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RotationModifierParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RotationModifierParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
