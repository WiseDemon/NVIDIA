...
const char* const IofxModuleParametersFactory::vptr =
    NxParameterized::getVptr<IofxModuleParameters, IofxModuleParameters::ClassAlignment>();
...
NxParameterized::MutexType IofxModuleParameters::mBuiltFlagMutex;

IofxModuleParameters::IofxModuleParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* IofxModuleParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* IofxModuleParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType IofxModuleParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType IofxModuleParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void IofxModuleParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void IofxModuleParameters::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=0, longName=""
	{
		...
		HintTable[0].init("shortDescription", "This class is used for initializing the NxModuleIofx.", true);
