...
void IofxActorCPU::runModifiers()
{
	...
	else
	{
		if (mDistanceSortingEnabled)
		{
			...
			iofx::ARLSort<PxU32, PxU32>::sort(keys, values, (physx::PxI32)range.objectCount);
...
IofxAssetSceneInstCPU::IofxAssetSceneInstCPU(IofxAsset* asset, PxU32 semantics, IofxScene* scene)
