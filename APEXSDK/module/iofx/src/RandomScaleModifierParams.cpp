...
const char* const RandomScaleModifierParamsFactory::vptr =
    NxParameterized::getVptr<RandomScaleModifierParams, RandomScaleModifierParams::ClassAlignment>();
...
NxParameterized::MutexType RandomScaleModifierParams::mBuiltFlagMutex;

RandomScaleModifierParams::RandomScaleModifierParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* RandomScaleModifierParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* RandomScaleModifierParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType RandomScaleModifierParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType RandomScaleModifierParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void RandomScaleModifierParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void RandomScaleModifierParams::initDefaults(void)
{
	...
	freeReferences();
	freeDynamicArrays();
	minScaleFactor = physx::PxF32(1.0f);
	maxScaleFactor = physx::PxF32(1.0f);
