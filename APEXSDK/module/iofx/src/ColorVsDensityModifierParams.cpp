...
const char* const ColorVsDensityModifierParamsFactory::vptr =
    NxParameterized::getVptr<ColorVsDensityModifierParams, ColorVsDensityModifierParams::ClassAlignment>();
...
NxParameterized::MutexType ColorVsDensityModifierParams::mBuiltFlagMutex;

ColorVsDensityModifierParams::ColorVsDensityModifierParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ColorVsDensityModifierParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ColorVsDensityModifierParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ColorVsDensityModifierParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ColorVsDensityModifierParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ColorVsDensityModifierParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
