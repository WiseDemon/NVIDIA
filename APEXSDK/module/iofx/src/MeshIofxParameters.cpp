...
const char* const MeshIofxParametersFactory::vptr =
    NxParameterized::getVptr<MeshIofxParameters, MeshIofxParameters::ClassAlignment>();
...
NxParameterized::MutexType MeshIofxParameters::mBuiltFlagMutex;

MeshIofxParameters::MeshIofxParameters(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* MeshIofxParameters::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* MeshIofxParameters::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType MeshIofxParameters::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType MeshIofxParameters::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void MeshIofxParameters::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
