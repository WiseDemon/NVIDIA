...
const char* const ScaleVsDensity2DModifierParamsFactory::vptr =
    NxParameterized::getVptr<ScaleVsDensity2DModifierParams, ScaleVsDensity2DModifierParams::ClassAlignment>();
...
NxParameterized::MutexType ScaleVsDensity2DModifierParams::mBuiltFlagMutex;

ScaleVsDensity2DModifierParams::ScaleVsDensity2DModifierParams(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* ScaleVsDensity2DModifierParams::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* ScaleVsDensity2DModifierParams::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType ScaleVsDensity2DModifierParams::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType ScaleVsDensity2DModifierParams::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void ScaleVsDensity2DModifierParams::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void ScaleVsDensity2DModifierParams::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=1, longName="controlPoints"
	{
		...
		HintTable[2].init("CURVE_Y_SCALE", physx::PxU64(1), true);
