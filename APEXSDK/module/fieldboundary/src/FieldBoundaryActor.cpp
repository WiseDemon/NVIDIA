...
void FieldBoundaryActor::getPhysicalLodRange(physx::PxF32& min, physx::PxF32& max, bool& intOnly) const
{
	PX_UNUSED(min);
	PX_UNUSED(max);
	PX_UNUSED(intOnly);
...
physx::PxF32 FieldBoundaryActor::getActivePhysicalLod() const
{
