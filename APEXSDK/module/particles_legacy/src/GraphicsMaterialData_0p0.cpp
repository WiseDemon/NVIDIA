...
const char* const GraphicsMaterialData_0p0Factory::vptr =
    NxParameterized::getVptr<GraphicsMaterialData_0p0, GraphicsMaterialData_0p0::ClassAlignment>();
...
NxParameterized::MutexType GraphicsMaterialData_0p0::mBuiltFlagMutex;

GraphicsMaterialData_0p0::GraphicsMaterialData_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GraphicsMaterialData_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
