...
const char* const EffectPackageAssetParams_0p0Factory::vptr =
    NxParameterized::getVptr<EffectPackageAssetParams_0p0, EffectPackageAssetParams_0p0::ClassAlignment>();
...
NxParameterized::MutexType EffectPackageAssetParams_0p0::mBuiltFlagMutex;

EffectPackageAssetParams_0p0::EffectPackageAssetParams_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EffectPackageAssetParams_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EffectPackageAssetParams_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EffectPackageAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EffectPackageAssetParams_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EffectPackageAssetParams_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
