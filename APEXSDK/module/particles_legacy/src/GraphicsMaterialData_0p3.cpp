...
const char* const GraphicsMaterialData_0p3Factory::vptr =
    NxParameterized::getVptr<GraphicsMaterialData_0p3, GraphicsMaterialData_0p3::ClassAlignment>();
...
NxParameterized::MutexType GraphicsMaterialData_0p3::mBuiltFlagMutex;

GraphicsMaterialData_0p3::GraphicsMaterialData_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p3::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GraphicsMaterialData_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
