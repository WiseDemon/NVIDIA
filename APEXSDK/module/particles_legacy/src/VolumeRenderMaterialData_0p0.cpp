...
const char* const VolumeRenderMaterialData_0p0Factory::vptr =
    NxParameterized::getVptr<VolumeRenderMaterialData_0p0, VolumeRenderMaterialData_0p0::ClassAlignment>();
...
NxParameterized::MutexType VolumeRenderMaterialData_0p0::mBuiltFlagMutex;

VolumeRenderMaterialData_0p0::VolumeRenderMaterialData_0p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* VolumeRenderMaterialData_0p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* VolumeRenderMaterialData_0p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType VolumeRenderMaterialData_0p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType VolumeRenderMaterialData_0p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void VolumeRenderMaterialData_0p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
