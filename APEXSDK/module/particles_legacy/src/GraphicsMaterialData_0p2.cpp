...
const char* const GraphicsMaterialData_0p2Factory::vptr =
    NxParameterized::getVptr<GraphicsMaterialData_0p2, GraphicsMaterialData_0p2::ClassAlignment>();
...
NxParameterized::MutexType GraphicsMaterialData_0p2::mBuiltFlagMutex;

GraphicsMaterialData_0p2::GraphicsMaterialData_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GraphicsMaterialData_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void GraphicsMaterialData_0p2::initDefaults(void)
{
	...
	PSM_Frustum.FrustumDistance = physx::PxF32(10.000000000);
