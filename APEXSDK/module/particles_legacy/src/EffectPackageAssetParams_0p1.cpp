...
const char* const EffectPackageAssetParams_0p1Factory::vptr =
    NxParameterized::getVptr<EffectPackageAssetParams_0p1, EffectPackageAssetParams_0p1::ClassAlignment>();
...
NxParameterized::MutexType EffectPackageAssetParams_0p1::mBuiltFlagMutex;

EffectPackageAssetParams_0p1::EffectPackageAssetParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EffectPackageAssetParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EffectPackageAssetParams_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EffectPackageAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EffectPackageAssetParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EffectPackageAssetParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
