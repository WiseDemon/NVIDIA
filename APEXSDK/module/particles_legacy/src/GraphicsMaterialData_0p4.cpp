...
const char* const GraphicsMaterialData_0p4Factory::vptr =
    NxParameterized::getVptr<GraphicsMaterialData_0p4, GraphicsMaterialData_0p4::ClassAlignment>();
...
NxParameterized::MutexType GraphicsMaterialData_0p4::mBuiltFlagMutex;

GraphicsMaterialData_0p4::GraphicsMaterialData_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* GraphicsMaterialData_0p4::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType GraphicsMaterialData_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void GraphicsMaterialData_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void GraphicsMaterialData_0p4::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=5, longName="DiffuseTexture"
	{
		...
		static HintImpl HintTable[1];
		static Hint* HintPtrTable[1] = { &HintTable[0], };
		HintTable[0].init("NAME_CALLBACK", physx::PxU64(1), true);
...
void GraphicsMaterialData_0p4::initDefaults(void)
{
	...
	PSM_Frustum.FrustumDepth = physx::PxF32(10.000000000);
	PSM_Frustum.FrustumSize = physx::PxF32(10.000000000);
