...
const char* const EffectPackageDatabaseParams_0p1Factory::vptr =
    NxParameterized::getVptr<EffectPackageDatabaseParams_0p1, EffectPackageDatabaseParams_0p1::ClassAlignment>();
...
NxParameterized::MutexType EffectPackageDatabaseParams_0p1::mBuiltFlagMutex;

EffectPackageDatabaseParams_0p1::EffectPackageDatabaseParams_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* EffectPackageDatabaseParams_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* EffectPackageDatabaseParams_0p1::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType EffectPackageDatabaseParams_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType EffectPackageDatabaseParams_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void EffectPackageDatabaseParams_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
