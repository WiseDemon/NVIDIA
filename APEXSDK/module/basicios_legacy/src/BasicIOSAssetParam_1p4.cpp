...
using namespace BasicIOSAssetParam_1p4NS;

const char* const BasicIOSAssetParam_1p4Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_1p4, BasicIOSAssetParam_1p4::ClassAlignment>();

const physx::PxU32 NumParamDefs = 38;
...
bool BasicIOSAssetParam_1p4::mBuiltFlag = false;
NxParameterized::MutexType BasicIOSAssetParam_1p4::mBuiltFlagMutex;

BasicIOSAssetParam_1p4::BasicIOSAssetParam_1p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicIOSAssetParam_1p4FactoryInst);
...
BasicIOSAssetParam_1p4::~BasicIOSAssetParam_1p4()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicIOSAssetParam_1p4::destroy()
{
	...
	this->~BasicIOSAssetParam_1p4();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* BasicIOSAssetParam_1p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_1p4::getParameterDefinitionTree(void) const
{
	BasicIOSAssetParam_1p4* tmpParam = const_cast<BasicIOSAssetParam_1p4*>(this);
...
NxParameterized::ErrorType BasicIOSAssetParam_1p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_1p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_1p4::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicIOSAssetParam_1p4::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicIOSAssetParam_1p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_1p4::buildTree(void)
{
...
void BasicIOSAssetParam_1p4::initStrings(void)
{
...
void BasicIOSAssetParam_1p4::initDynamicArrays(void)
{
}

void BasicIOSAssetParam_1p4::initDefaults(void)
{
...
void BasicIOSAssetParam_1p4::initReferences(void)
{
}

void BasicIOSAssetParam_1p4::freeDynamicArrays(void)
{
}

void BasicIOSAssetParam_1p4::freeStrings(void)
{
...
void BasicIOSAssetParam_1p4::freeReferences(void)
{
}
