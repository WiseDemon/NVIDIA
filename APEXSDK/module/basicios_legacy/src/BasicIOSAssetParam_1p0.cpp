...
const char* const BasicIOSAssetParam_1p0Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_1p0, BasicIOSAssetParam_1p0::ClassAlignment>();
...
NxParameterized::MutexType BasicIOSAssetParam_1p0::mBuiltFlagMutex;

BasicIOSAssetParam_1p0::BasicIOSAssetParam_1p0(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_1p0::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_1p0::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_1p0::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_1p0::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_1p0::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
