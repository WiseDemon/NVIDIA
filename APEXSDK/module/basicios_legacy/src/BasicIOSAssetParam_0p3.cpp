...
using namespace BasicIOSAssetParam_0p3NS;

const char* const BasicIOSAssetParam_0p3Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_0p3, BasicIOSAssetParam_0p3::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->particleMass), CHILDREN(9), 3 }, // particleMass
...
bool BasicIOSAssetParam_0p3::mBuiltFlag = false;
NxParameterized::MutexType BasicIOSAssetParam_0p3::mBuiltFlagMutex;

BasicIOSAssetParam_0p3::BasicIOSAssetParam_0p3(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicIOSAssetParam_0p3FactoryInst);
...
BasicIOSAssetParam_0p3::~BasicIOSAssetParam_0p3()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicIOSAssetParam_0p3::destroy()
{
	...
	this->~BasicIOSAssetParam_0p3();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p3::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p3::getParameterDefinitionTree(void) const
{
	BasicIOSAssetParam_0p3* tmpParam = const_cast<BasicIOSAssetParam_0p3*>(this);
...
NxParameterized::ErrorType BasicIOSAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p3::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p3::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicIOSAssetParam_0p3::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicIOSAssetParam_0p3::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_0p3::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=10, longName="particleMass.center"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=11, longName="particleMass.spread"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=12, longName="particleMass.type"
	{
		...
		ParamDefTable[12].setEnumVals((const char**)EnumVals, 2);
	...
	// SetChildren for: nodeIndex=9, longName="particleMass"
	{
...
void BasicIOSAssetParam_0p3::initStrings(void)
{
...
void BasicIOSAssetParam_0p3::initDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p3::initDefaults(void)
{
...
void BasicIOSAssetParam_0p3::initReferences(void)
{
}

void BasicIOSAssetParam_0p3::freeDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p3::freeStrings(void)
{
...
void BasicIOSAssetParam_0p3::freeReferences(void)
{
}
