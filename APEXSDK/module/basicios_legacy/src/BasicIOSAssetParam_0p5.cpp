...
using namespace BasicIOSAssetParam_0p5NS;

const char* const BasicIOSAssetParam_0p5Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_0p5, BasicIOSAssetParam_0p5::ClassAlignment>();
...
{
	1, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 18, 8, 9, 10,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->particleMass), CHILDREN(15), 3 }, // particleMass
...
bool BasicIOSAssetParam_0p5::mBuiltFlag = false;
NxParameterized::MutexType BasicIOSAssetParam_0p5::mBuiltFlagMutex;

BasicIOSAssetParam_0p5::BasicIOSAssetParam_0p5(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicIOSAssetParam_0p5FactoryInst);
...
BasicIOSAssetParam_0p5::~BasicIOSAssetParam_0p5()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicIOSAssetParam_0p5::destroy()
{
	...
	this->~BasicIOSAssetParam_0p5();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p5::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p5::getParameterDefinitionTree(void) const
{
	BasicIOSAssetParam_0p5* tmpParam = const_cast<BasicIOSAssetParam_0p5*>(this);
...
NxParameterized::ErrorType BasicIOSAssetParam_0p5::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p5::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p5::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicIOSAssetParam_0p5::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicIOSAssetParam_0p5::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_0p5::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=12, longName="fieldSamplerFilterDataName"
	{
		...
		static Hint* HintPtrTable[2] = { &HintTable[0], &HintTable[1], };
		HintTable[0].init("HIDDEN", physx::PxU64(1), true);
		HintTable[1].init("shortDescription", "The filter data name for IOS vs FieldSampler interaction.", true);
...
void BasicIOSAssetParam_0p5::initStrings(void)
{
...
void BasicIOSAssetParam_0p5::initDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p5::initDefaults(void)
{
...
void BasicIOSAssetParam_0p5::initReferences(void)
{
}

void BasicIOSAssetParam_0p5::freeDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p5::freeStrings(void)
{
...
void BasicIOSAssetParam_0p5::freeReferences(void)
{
}
