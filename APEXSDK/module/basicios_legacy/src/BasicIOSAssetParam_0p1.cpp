...
using namespace BasicIOSAssetParam_0p1NS;

const char* const BasicIOSAssetParam_0p1Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_0p1, BasicIOSAssetParam_0p1::ClassAlignment>();
...
bool BasicIOSAssetParam_0p1::mBuiltFlag = false;
NxParameterized::MutexType BasicIOSAssetParam_0p1::mBuiltFlagMutex;

BasicIOSAssetParam_0p1::BasicIOSAssetParam_0p1(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicIOSAssetParam_0p1FactoryInst);
...
BasicIOSAssetParam_0p1::~BasicIOSAssetParam_0p1()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicIOSAssetParam_0p1::destroy()
{
	...
	this->~BasicIOSAssetParam_0p1();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p1::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p1::getParameterDefinitionTree(void) const
{
	BasicIOSAssetParam_0p1* tmpParam = const_cast<BasicIOSAssetParam_0p1*>(this);
...
NxParameterized::ErrorType BasicIOSAssetParam_0p1::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p1::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p1::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicIOSAssetParam_0p1::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicIOSAssetParam_0p1::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_0p1::buildTree(void)
{
...
void BasicIOSAssetParam_0p1::initStrings(void)
{
}

void BasicIOSAssetParam_0p1::initDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p1::initDefaults(void)
{
...
void BasicIOSAssetParam_0p1::initReferences(void)
{
}

void BasicIOSAssetParam_0p1::freeDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p1::freeStrings(void)
{
}

void BasicIOSAssetParam_0p1::freeReferences(void)
{
}
