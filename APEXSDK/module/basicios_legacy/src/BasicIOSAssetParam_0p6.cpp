...
using namespace BasicIOSAssetParam_0p6NS;

const char* const BasicIOSAssetParam_0p6Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_0p6, BasicIOSAssetParam_0p6::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->particleMass), CHILDREN(17), 3 }, // particleMass
...
bool BasicIOSAssetParam_0p6::mBuiltFlag = false;
NxParameterized::MutexType BasicIOSAssetParam_0p6::mBuiltFlagMutex;

BasicIOSAssetParam_0p6::BasicIOSAssetParam_0p6(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicIOSAssetParam_0p6FactoryInst);
...
BasicIOSAssetParam_0p6::~BasicIOSAssetParam_0p6()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicIOSAssetParam_0p6::destroy()
{
	...
	this->~BasicIOSAssetParam_0p6();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p6::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p6::getParameterDefinitionTree(void) const
{
	BasicIOSAssetParam_0p6* tmpParam = const_cast<BasicIOSAssetParam_0p6*>(this);
...
NxParameterized::ErrorType BasicIOSAssetParam_0p6::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p6::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p6::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicIOSAssetParam_0p6::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicIOSAssetParam_0p6::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_0p6::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=18, longName="collisionThreshold"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=19, longName="collisionWithConvex"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=20, longName="collisionWithTriangleMesh"
	{
...
void BasicIOSAssetParam_0p6::initStrings(void)
{
...
void BasicIOSAssetParam_0p6::initDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p6::initDefaults(void)
{
...
void BasicIOSAssetParam_0p6::initReferences(void)
{
}

void BasicIOSAssetParam_0p6::freeDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p6::freeStrings(void)
{
...
void BasicIOSAssetParam_0p6::freeReferences(void)
{
}
