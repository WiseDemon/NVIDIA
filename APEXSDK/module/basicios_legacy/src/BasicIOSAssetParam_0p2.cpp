...
const char* const BasicIOSAssetParam_0p2Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_0p2, BasicIOSAssetParam_0p2::ClassAlignment>();
...
NxParameterized::MutexType BasicIOSAssetParam_0p2::mBuiltFlagMutex;

BasicIOSAssetParam_0p2::BasicIOSAssetParam_0p2(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p2::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p2::getParameterDefinitionTree(void) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p2::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p2::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p2::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
