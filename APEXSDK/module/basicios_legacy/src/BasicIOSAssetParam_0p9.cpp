...
using namespace BasicIOSAssetParam_0p9NS;

const char* const BasicIOSAssetParam_0p9Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_0p9, BasicIOSAssetParam_0p9::ClassAlignment>();
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->FakeDensityGrid), CHILDREN(22), 5 }, // FakeDensityGrid
	...
	{ TYPE_STRUCT, false, (size_t)(&((FakeDensityGridParams_Type*)0)->NormalParams), CHILDREN(27), 2 }, // FakeDensityGrid.NormalParams
	...
	{ TYPE_STRUCT, false, (size_t)(&((FakeDensityGridParams_Type*)0)->FrustumParams), CHILDREN(29), 2 }, // FakeDensityGrid.FrustumParams
...
bool BasicIOSAssetParam_0p9::mBuiltFlag = false;
NxParameterized::MutexType BasicIOSAssetParam_0p9::mBuiltFlagMutex;

BasicIOSAssetParam_0p9::BasicIOSAssetParam_0p9(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicIOSAssetParam_0p9FactoryInst);
...
BasicIOSAssetParam_0p9::~BasicIOSAssetParam_0p9()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicIOSAssetParam_0p9::destroy()
{
	...
	this->~BasicIOSAssetParam_0p9();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p9::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p9::getParameterDefinitionTree(void) const
{
	BasicIOSAssetParam_0p9* tmpParam = const_cast<BasicIOSAssetParam_0p9*>(this);
...
NxParameterized::ErrorType BasicIOSAssetParam_0p9::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p9::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p9::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicIOSAssetParam_0p9::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicIOSAssetParam_0p9::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_0p9::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=22, longName="FakeDensityGrid"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=23, longName="FakeDensityGrid.Enabled"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=24, longName="FakeDensityGrid.FrustumMode"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=25, longName="FakeDensityGrid.GridResolution"
	{
		...
		ParamDefTable[25].setEnumVals((const char**)EnumVals, 6);
	...
	// Initialize DefinitionImpl node: nodeIndex=26, longName="FakeDensityGrid.NormalParams"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=27, longName="FakeDensityGrid.NormalParams.GridSize"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=28, longName="FakeDensityGrid.NormalParams.GridMaxCellCount"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=29, longName="FakeDensityGrid.FrustumParams"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=30, longName="FakeDensityGrid.FrustumParams.GridSize"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=31, longName="FakeDensityGrid.FrustumParams.GridMaxCellCount"
	{
	...
	// SetChildren for: nodeIndex=22, longName="FakeDensityGrid"
	{
		...
		ParamDefTable[22].setChildren(Children, 5);
	}

	// SetChildren for: nodeIndex=26, longName="FakeDensityGrid.NormalParams"
	{
	...
	// SetChildren for: nodeIndex=29, longName="FakeDensityGrid.FrustumParams"
	{
		static Definition* Children[2];
		Children[0] = PDEF_PTR(30);
		Children[1] = PDEF_PTR(31);

		ParamDefTable[29].setChildren(Children, 2);
	}

	mBuiltFlag = true;

}
void BasicIOSAssetParam_0p9::initStrings(void)
{
...
void BasicIOSAssetParam_0p9::initDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p9::initDefaults(void)
{
	...
	FakeDensityGrid.NormalParams.GridSize = physx::PxF32(10);
	FakeDensityGrid.NormalParams.GridMaxCellCount = physx::PxU32(16);
	FakeDensityGrid.FrustumParams.GridSize = physx::PxF32(10);
	FakeDensityGrid.FrustumParams.GridMaxCellCount = physx::PxU32(16);
...
void BasicIOSAssetParam_0p9::initReferences(void)
{
}

void BasicIOSAssetParam_0p9::freeDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p9::freeStrings(void)
{
...
void BasicIOSAssetParam_0p9::freeReferences(void)
{
}
