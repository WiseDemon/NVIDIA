...
using namespace BasicIOSAssetParam_0p4NS;

const char* const BasicIOSAssetParam_0p4Factory::vptr =
    NxParameterized::getVptr<BasicIOSAssetParam_0p4, BasicIOSAssetParam_0p4::ClassAlignment>();
...
{
	1, 2, 3, 4, 5, 6, 7, 11, 12, 13, 14, 15, 16, 17, 8, 9, 10,
};
...
static const NxParameterized::ParamLookupNode ParamLookupTable[NumParamDefs] =
{
	...
	{ TYPE_STRUCT, false, (size_t)(&((ParametersStruct*)0)->particleMass), CHILDREN(14), 3 }, // particleMass
...
bool BasicIOSAssetParam_0p4::mBuiltFlag = false;
NxParameterized::MutexType BasicIOSAssetParam_0p4::mBuiltFlagMutex;

BasicIOSAssetParam_0p4::BasicIOSAssetParam_0p4(NxParameterized::Traits* traits, void* buf, PxI32* refCount) :
	NxParameters(traits, buf, refCount)
{
	//mParameterizedTraits->registerFactory(className(), &BasicIOSAssetParam_0p4FactoryInst);
...
BasicIOSAssetParam_0p4::~BasicIOSAssetParam_0p4()
{
	freeStrings();
	freeReferences();
	freeDynamicArrays();
...
void BasicIOSAssetParam_0p4::destroy()
{
	...
	this->~BasicIOSAssetParam_0p4();

	NxParameters::destroy(this, traits, doDeallocateSelf, refCount, buf);
}

const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p4::getParameterDefinitionTree(void)
{
...
const NxParameterized::DefinitionImpl* BasicIOSAssetParam_0p4::getParameterDefinitionTree(void) const
{
	BasicIOSAssetParam_0p4* tmpParam = const_cast<BasicIOSAssetParam_0p4*>(this);
...
NxParameterized::ErrorType BasicIOSAssetParam_0p4::getParameterHandle(const char* long_name, Handle& handle) const
{
...
NxParameterized::ErrorType BasicIOSAssetParam_0p4::getParameterHandle(const char* long_name, Handle& handle)
{
	ErrorType Ret = NxParameters::getParameterHandle(long_name, handle);
	if (Ret != ERROR_NONE)
	{
...
void BasicIOSAssetParam_0p4::getVarPtr(const Handle& handle, void*& ptr, size_t& offset) const
{
	ptr = getVarPtrHelper(&ParamLookupTable[0], const_cast<BasicIOSAssetParam_0p4::ParametersStruct*>(&parameters()), handle, offset);
}


/* Dynamic Handle Indices */

void BasicIOSAssetParam_0p4::freeParameterDefinitionTable(NxParameterized::Traits* traits)
{
	if (!traits)
	{
		return;
...
void BasicIOSAssetParam_0p4::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=7, longName="particleMass"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=8, longName="particleMass.center"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=9, longName="particleMass.spread"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=10, longName="particleMass.type"
	{
		...
		ParamDefTable[10].setEnumVals((const char**)EnumVals, 2);
	...
	// Initialize DefinitionImpl node: nodeIndex=11, longName="collisionFilterDataName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=13, longName="staticCollision"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=14, longName="restitutionForStaticShapes"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=15, longName="dynamicCollision"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=16, longName="restitutionForDynamicShapes"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=17, longName="collisionDistanceMultiplier"
	{
		...
		HintTable[0].init("gameScale", "true", true);
		HintTable[1].init("min", physx::PxU64(0), true);
		HintTable[2].init("shortDescription", "Defines the distance (= collisionDistanceMultiplier*particleRadius) between particles and collision geometry, which is maintained during simulation.", true);
	...
	// SetChildren for: nodeIndex=7, longName="particleMass"
	{
		...
		ParamDefTable[7].setChildren(Children, 3);
	}

	mBuiltFlag = true;

}
void BasicIOSAssetParam_0p4::initStrings(void)
{
...
void BasicIOSAssetParam_0p4::initDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p4::initDefaults(void)
{
...
void BasicIOSAssetParam_0p4::initReferences(void)
{
}

void BasicIOSAssetParam_0p4::freeDynamicArrays(void)
{
}

void BasicIOSAssetParam_0p4::freeStrings(void)
{
...
void BasicIOSAssetParam_0p4::freeReferences(void)
{
}
