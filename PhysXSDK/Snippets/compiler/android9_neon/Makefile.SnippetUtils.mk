...
SnippetUtils_debug_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_debug_cppflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_debug_bin      := ./../../lib/android9_neon/libSnippetUtilsDEBUG.a
...
$(SnippetUtils_debug_bin): $(SnippetUtils_debug_obj) 
	@mkdir -p `dirname ./../../lib/android9_neon/libSnippetUtilsDEBUG.a`
...
SnippetUtils_checked_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_checked_cppflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_checked_bin      := ./../../lib/android9_neon/libSnippetUtilsCHECKED.a
...
$(SnippetUtils_checked_bin): $(SnippetUtils_checked_obj) 
	@mkdir -p `dirname ./../../lib/android9_neon/libSnippetUtilsCHECKED.a`
...
SnippetUtils_profile_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_profile_cppflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_profile_bin      := ./../../lib/android9_neon/libSnippetUtilsPROFILE.a
...
$(SnippetUtils_profile_bin): $(SnippetUtils_profile_obj) 
	@mkdir -p `dirname ./../../lib/android9_neon/libSnippetUtilsPROFILE.a`
...
SnippetUtils_release_cflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_release_cppflags  += -march=armv7-a -mfpu=neon -marm -mfloat-abi=softfp -mthumb-interwork
...
SnippetUtils_release_bin      := ./../../lib/android9_neon/libSnippetUtils.a
...
$(SnippetUtils_release_bin): $(SnippetUtils_release_obj) 
	@mkdir -p `dirname ./../../lib/android9_neon/libSnippetUtils.a`
