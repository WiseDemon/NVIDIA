...
#include "Ps.h" // needs to be first to suppress offsetof warnings
...
void PxVehicleWheels::importExtraData(PxDeserializationContext& context)
{
	...
	patchupPointers(this, ptr, mWheelsSimData.mNbWheels4, mWheelsSimData.mNbActiveWheels, false);
}
...
void PxVehicleWheels4DynData::getBinaryMetaData(PxOutputStream& stream)
{
	...
	PX_DEF_BIN_METADATA_ITEMS_AUTO(stream,	PxVehicleWheels4DynData,	PxU8, 						mRaycastsOrCachedHitResults,	0)	
	...
	PX_DEF_BIN_METADATA_ITEM(stream,		PxVehicleWheels4DynData,	PxRaycastQueryResult,		mSqResults,						PxMetaDataFlag::ePTR)
