...
PhysX_release_dep      = $(PhysX_cpp_release_dep) $(PhysX_c_release_dep)
...
PhysX_debug_dep      = $(PhysX_cpp_debug_dep) $(PhysX_c_debug_dep)
...
PhysX_checked_dep      = $(PhysX_cpp_checked_dep) $(PhysX_c_checked_dep)
...
PhysX_profile_dep      = $(PhysX_cpp_profile_dep) $(PhysX_c_profile_dep)
...
PhysX_release_lpaths    += ./../../../Lib/android9
...
PhysX_release_cflags  += -Werror
PhysX_release_cflags  += -fpic -fno-exceptions
PhysX_release_cflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_release_cflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_release_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_release_cflags  += -Wno-long-long
PhysX_release_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_release_cflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_release_cflags  += -Wno-variadic-macros
PhysX_release_cflags  += -std=c99
PhysX_release_cflags  += -O3 -fno-strict-aliasing
PhysX_release_cflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysX_release_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
PhysX_release_cppflags	:= $(PhysX_release_common_cflags)
PhysX_release_cppflags  += -Werror
PhysX_release_cppflags  += -fno-rtti
PhysX_release_cppflags  += -fpic -fno-exceptions
PhysX_release_cppflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_release_cppflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_release_cppflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_release_cppflags  += -Wno-long-long
PhysX_release_cppflags  += -Wno-invalid-offsetof
PhysX_release_cppflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_release_cppflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_release_cppflags  += -Wno-variadic-macros
PhysX_release_cppflags  += -O3 -fno-strict-aliasing
PhysX_release_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysX_release_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
PhysX_release_lflags  += --sysroot=../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
...
PhysX_release_obj      = $(PhysX_release_cpp_o) $(PhysX_release_c_o)
PhysX_release_bin      := ./../../../Lib/android9/libPhysX3.a
...
$(PhysX_release_bin): $(PhysX_release_obj) build_LowLevel_release build_LowLevelCloth_release build_PhysXCommon_release build_PhysXProfileSDK_release build_PhysXVisualDebuggerSDK_release build_PvdRuntime_release build_PxTask_release build_SceneQuery_release build_SimulationController_release 
	@mkdir -p `dirname ./../../../Lib/android9/libPhysX3.a`
...
PhysX_debug_lpaths    := 
PhysX_debug_lpaths    += ./../../../Lib/android9
...
PhysX_debug_cflags  += -Werror
PhysX_debug_cflags  += -fpic -fno-exceptions
PhysX_debug_cflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_debug_cflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_debug_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_debug_cflags  += -Wno-long-long
PhysX_debug_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_debug_cflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_debug_cflags  += -Wno-variadic-macros
PhysX_debug_cflags  += -std=c99
PhysX_debug_cflags  += -g3 -gdwarf-2
PhysX_debug_cppflags	:= $(PhysX_debug_common_cflags)
PhysX_debug_cppflags  += -Werror
PhysX_debug_cppflags  += -fno-rtti
PhysX_debug_cppflags  += -fpic -fno-exceptions
PhysX_debug_cppflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_debug_cppflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_debug_cppflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_debug_cppflags  += -Wno-long-long
PhysX_debug_cppflags  += -Wno-invalid-offsetof
PhysX_debug_cppflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_debug_cppflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_debug_cppflags  += -Wno-variadic-macros
PhysX_debug_cppflags  += -g3 -gdwarf-2
...
PhysX_debug_lflags  += --sysroot=../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
...
PhysX_debug_obj      = $(PhysX_debug_cpp_o) $(PhysX_debug_c_o)
PhysX_debug_bin      := ./../../../Lib/android9/libPhysX3DEBUG.a
...
$(PhysX_debug_bin): $(PhysX_debug_obj) build_LowLevel_debug build_LowLevelCloth_debug build_PhysXCommon_debug build_PhysXProfileSDK_debug build_PhysXVisualDebuggerSDK_debug build_PvdRuntime_debug build_PxTask_debug build_SceneQuery_debug build_SimulationController_debug 
	@mkdir -p `dirname ./../../../Lib/android9/libPhysX3DEBUG.a`
...
PhysX_checked_lpaths    += ./../../../Lib/android9
...
PhysX_checked_cflags  += -Werror
PhysX_checked_cflags  += -fpic -fno-exceptions
PhysX_checked_cflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_checked_cflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_checked_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_checked_cflags  += -Wno-long-long
PhysX_checked_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_checked_cflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_checked_cflags  += -Wno-variadic-macros
PhysX_checked_cflags  += -std=c99
PhysX_checked_cflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
PhysX_checked_cflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysX_checked_cflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
PhysX_checked_cppflags	:= $(PhysX_checked_common_cflags)
PhysX_checked_cppflags  += -Werror
PhysX_checked_cppflags  += -fno-rtti
PhysX_checked_cppflags  += -fpic -fno-exceptions
PhysX_checked_cppflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_checked_cppflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_checked_cppflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_checked_cppflags  += -Wno-long-long
PhysX_checked_cppflags  += -Wno-invalid-offsetof
PhysX_checked_cppflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_checked_cppflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_checked_cppflags  += -Wno-variadic-macros
PhysX_checked_cppflags  += -g3 -gdwarf-2 -O3 -fno-strict-aliasing
PhysX_checked_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysX_checked_cppflags  += -fomit-frame-pointer -funswitch-loops -finline-limit=300
...
PhysX_checked_lflags  += --sysroot=../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
...
PhysX_checked_obj      = $(PhysX_checked_cpp_o) $(PhysX_checked_c_o)
PhysX_checked_bin      := ./../../../Lib/android9/libPhysX3CHECKED.a
...
$(PhysX_checked_bin): $(PhysX_checked_obj) build_LowLevel_checked build_LowLevelCloth_checked build_PhysXCommon_checked build_PhysXProfileSDK_checked build_PhysXVisualDebuggerSDK_checked build_PvdRuntime_checked build_PxTask_checked build_SceneQuery_checked build_SimulationController_checked 
	@mkdir -p `dirname ./../../../Lib/android9/libPhysX3CHECKED.a`
...
PhysX_profile_lpaths    += ./../../../Lib/android9
...
PhysX_profile_cflags  += -Werror
PhysX_profile_cflags  += -fpic -fno-exceptions
PhysX_profile_cflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_profile_cflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_profile_cflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_profile_cflags  += -Wno-long-long
PhysX_profile_cflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_profile_cflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_profile_cflags  += -Wno-variadic-macros
PhysX_profile_cflags  += -std=c99
PhysX_profile_cflags  += -O3 -fno-strict-aliasing
PhysX_profile_cflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysX_profile_cflags  += -fno-omit-frame-pointer -funswitch-loops -finline-limit=300
PhysX_profile_cppflags	:= $(PhysX_profile_common_cflags)
PhysX_profile_cppflags  += -Werror
PhysX_profile_cppflags  += -fno-rtti
PhysX_profile_cppflags  += -fpic -fno-exceptions
PhysX_profile_cppflags  += -isysroot ../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
PhysX_profile_cppflags  += -march=armv7-a -mfpu=vfpv3-d16 -marm -mfloat-abi=softfp -mthumb-interwork
PhysX_profile_cppflags  += -Wall -Wextra -Wpedantic -Wstrict-aliasing=2
PhysX_profile_cppflags  += -Wno-long-long
PhysX_profile_cppflags  += -Wno-invalid-offsetof
PhysX_profile_cppflags  += -Wno-unknown-pragmas -Wno-maybe-uninitialized -Wno-unused-variable -Wno-unused-local-typedefs
PhysX_profile_cppflags  += -Wno-unused-parameter -Wno-enum-compare
PhysX_profile_cppflags  += -Wno-variadic-macros
PhysX_profile_cppflags  += -O3 -fno-strict-aliasing
PhysX_profile_cppflags  += -ffunction-sections -funwind-tables -fstack-protector
PhysX_profile_cppflags  += -fno-omit-frame-pointer -funswitch-loops -finline-limit=300
...
PhysX_profile_lflags  += --sysroot=../../../externals/android-ndk-r9d/platforms/android-9/arch-arm
...
PhysX_profile_obj      = $(PhysX_profile_cpp_o) $(PhysX_profile_c_o)
PhysX_profile_bin      := ./../../../Lib/android9/libPhysX3PROFILE.a
...
$(PhysX_profile_bin): $(PhysX_profile_obj) build_LowLevel_profile build_LowLevelCloth_profile build_PhysXCommon_profile build_PhysXProfileSDK_profile build_PhysXVisualDebuggerSDK_profile build_PvdRuntime_profile build_PxTask_profile build_SceneQuery_profile build_SimulationController_profile 
	@mkdir -p `dirname ./../../../Lib/android9/libPhysX3PROFILE.a`
